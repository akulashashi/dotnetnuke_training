<%@ Control Language="C#"  AutoEventWireup="true" CodeBehind="ViewThumbs.ascx.cs" Inherits="bhattji.Modules.MyLogins.ViewThumbs" %>
...
<%= GetMarquee() %><asp:DataList ID="lstViewThumbs" runat="server" 
    Summary="MyLogin Thumbnails Design Table" RepeatColumns="5" GridLines="None" 
    Width="100%" CssClass="dnnGrid">  <%--DataSourceID="odsMyLogins"--%>
    <ItemTemplate>
        ...
        <asp:PlaceHolder ID="phtMyLoginDescription" runat="server" /><br />
