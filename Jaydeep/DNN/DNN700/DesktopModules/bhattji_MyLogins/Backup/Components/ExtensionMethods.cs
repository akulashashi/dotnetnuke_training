...
namespace bhattji.Modules.MyLogins
{
    ...
    public static class IDataReaderHelper
    {
        ...
        //public static List<MyLoginInfo> ToLOT(IDataReader thisDR)
        public static List<MyLoginInfo> ToLOT(this IDataReader thisDR)
        {
            return CBO.FillCollection<MyLoginInfo>(thisDR);
        }

        //public static List<MyLoginInfo> ToLOT(IDataReader thisDR)
        public static List<MyLoginInfo> ToLOT(this IDataReader thisDR, ref int totalRecords)
        {
            return CBO.FillCollection<MyLoginInfo>(thisDR, ref totalRecords);
        }

        //public static List<MyLoginInfo> ToLOT(IDataReader thisDR, ref IList<MyLoginInfo> objToFill)
        public static IList<MyLoginInfo> ToLOT(this IDataReader thisDR, ref IList<MyLoginInfo> objToFill)
        {
            return CBO.FillCollection<MyLoginInfo>(thisDR, ref objToFill);
        }
    }
