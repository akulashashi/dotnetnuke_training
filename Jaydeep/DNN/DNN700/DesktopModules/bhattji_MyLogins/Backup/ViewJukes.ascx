<%@ Control Language="C#" AutoEventWireup="true" Codebehind="ViewJukes.ascx.cs"  Inherits="bhattji.Modules.MyLogins.ViewJukes" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewJukes" DataSourceID="odsMyLogins" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="100%" EmptyDataText="<center class='NormalRed'>No MyLogin Defined</center>" CssClass="dnnGrid">
    <Columns>
