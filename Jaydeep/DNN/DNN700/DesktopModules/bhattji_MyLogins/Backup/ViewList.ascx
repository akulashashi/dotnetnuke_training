<%@ Control Language="C#" AutoEventWireup="true" Codebehind="ViewList.ascx.cs" Inherits="bhattji.Modules.MyLogins.ViewList" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewList" DataSourceID="odsMyLogins" 
