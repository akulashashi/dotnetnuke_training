<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewGrid.ascx.cs" Inherits="bhattji.Modules.MyLogins.ViewGrid" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewGrid" DataSourceID="odsMyLogins" 
    runat="server" AllowPaging="True" AllowSorting="True" 
    AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="100%" 
    EmptyDataText="<center class='NormalRed'>No MyLogin Defined</center>" 
    CssClass="dnnGrid">
    <Columns>
        ...
        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="Title">
            <ItemTemplate>
							<asp:PlaceHolder id="phtMyLoginDescription" runat="server" />&nbsp;
