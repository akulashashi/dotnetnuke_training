<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewCat.ascx.cs" Inherits="bhattji.Modules.MyLogins.ViewCat" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewCat" DataSourceID="odsMyLogins" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="100%" EmptyDataText="<center class='NormalRed'>No MyLogin Defined</center>" CssClass="dnnGrid">
    <Columns>
        ...
        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="Title">
            <ItemTemplate>
							...
							<asp:PlaceHolder id="phtMyLoginDescription" runat="server" />&nbsp;<asp:HyperLink id="hypMoreLink" CssClass="Normal" ResourceKey="ReadMore" runat="server" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
    <EmptyDataTemplate>
        <p class="NormalRed" align="center">No MyLogin Defined<br />
...
<asp:ObjectDataSource ID="odsMyLogins" runat="server" />
