<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewPQR45s.ascx.cs" Inherits="bhattji.Modules.MyLogins.ViewPQR45s" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<div class="dnnLeft">
    <div id="divManagePQR45s" runat="server">
        <asp:GridView ID="gdvPQR45s" DataSourceID="odsPQR45s" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId,MyLoginId" GridLines="None" EmptyDataText="<center class='NormalRed'>No MyLogin PQR45 Defined</center>" CssClass="dnnGrid">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                ...
                <asp:BoundField DataField="MyLoginTitle" HeaderText="MyLoginTitle" SortExpression="MyLoginTitle" ReadOnly="True" />
            ...
            <EmptyDataTemplate>
                <p class="NormalRed" align="center">No MyLogin PQR45 Defined<br />
        ...
        <div class="dnnForm" id="frmAddCategory">
            <fieldset>
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:RequiredFieldValidator ID="valPQR45" ControlToValidate="txtPQR45" ErrorMessage="You Must Enter A PQR45 For The MyLogin" ResourceKey="PQR45.ErrorMessage" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" runat="server" />
                </div>
                <div class="dnnFormItem">
