<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewCategories.ascx.cs" Inherits="bhattji.Modules.MyLogins.ViewCategories" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<div class="dnnLeft">
    <div id="divManageCategories" runat="server">
        <asp:GridView ID="gdvCategories" DataSourceID="odsCategories" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId,ModuleId" GridLines="None" EmptyDataText="<center class='NormalRed'>No MyLogin Category Defined</center>" CssClass="dnnGrid">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
            ...
            <EmptyDataTemplate>
                <p class="NormalRed" align="center">No MyLogin Category Defined<br />
        ...
        <div class="dnnForm" id="frmAddCategory">
            <fieldset>
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:RequiredFieldValidator ID="valCategory" ControlToValidate="txtCategory" ErrorMessage="You Must Enter A Category For The MyLogin" ResourceKey="Category.ErrorMessage" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" runat="server" />
                </div>
                <div class="dnnFormItem">
