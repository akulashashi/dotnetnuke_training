<%@ Control Language="C#" AutoEventWireup="true" Codebehind="Details.ascx.cs" Inherits="bhattji.Modules.MyLogins.Details" %>
...
<table width="100%">
	...
	<tr>
		<td colspan="2">
			...
			<asp:PlaceHolder id="phtMyLoginDetails" runat="server" />
