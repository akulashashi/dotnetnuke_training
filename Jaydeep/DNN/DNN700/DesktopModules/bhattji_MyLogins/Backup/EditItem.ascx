<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditItem.ascx.cs" Inherits="bhattji.Modules.MyLogins.EditItem" %>
    ...
    <div id="tabBasic" class="dnnClear">
        <fieldset>
            <div class="dnnFormItem">
                ...
                <asp:RequiredFieldValidator ID="valTitle" ControlToValidate="txtTitle" ErrorMessage="You Must Enter A Title For The MyLogin" ResourceKey="Title.ErrorMessage" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" runat="server" />
            </div>
            <div class="dnnFormItem">
        ...
        <fieldset>
            ...
            <div class="dnnFormItem">
                ...
                <div class="dnnLeft" style="width: 480px">
                    ...
                    <asp:RequiredFieldValidator ID="valDescription" ResourceKey="Description.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="teDescription" ErrorMessage="You Must Enter A Description Of The MyLogin" Display="Dynamic" />
                </div>
            </div>
        </fieldset>
    </div>
        ...
        <fieldset>
            <div class="dnnFormItem">
                ...
                <div class="dnnLeft" style="width: 480px">
                    ...
                    <asp:RequiredFieldValidator ID="valDetails" ResourceKey="Details.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="teDetails" ErrorMessage="You Must Enter A Details Of The MyLogin" Display="Dynamic" />
                </div>
            </div>
            <div class="dnnFormItem">
    ...
    <div id="tabOther" class="dnnClear">
        <fieldset>
            ...
            <div class="dnnFormItem">
                ...
                <asp:TextBox ID="txtPublishDate" runat="server" Width="90px" /><asp:HyperLink runat="server" ID="hypPublishDate" ImageUrl="~/images/calendar.png" Style="cursor: hand" /><asp:CompareValidator ID="valPublishDate" ResourceKey="PublishDate.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="txtPublishDate" ErrorMessage="PublishDate must be a valid date value." Display="Dynamic" Type="Date" Operator="DataTypeCheck" />
            </div>
            <div class="dnnFormItem">
                <dnn:Label id="plExpiryDate" ControlName="txtExpiryDate" Suffix=":" runat="server" />
                <asp:TextBox ID="txtExpiryDate" runat="server" Width="90px" /><asp:HyperLink runat="server" ID="hypExpiryDate" ImageUrl="~/images/calendar.png" Style="cursor: hand" /><asp:CompareValidator ID="valExpiryDate" ResourceKey="ExpiryDate.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="txtExpiryDate" ErrorMessage="ExpiryDate must be a valid date value." Display="Dynamic" Type="Date" Operator="DataTypeCheck" />
            </div>
            <div class="dnnFormItem">
