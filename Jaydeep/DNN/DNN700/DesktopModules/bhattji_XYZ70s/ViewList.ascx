...
<asp:TextBox ID="txtDateCheck" runat="server" TextMode="Date" /><asp:Button ID="btnDateCheck" runat="server" Text="Date Check"  OnClick="btnDateCheck_Click" /><br />
<asp:Label ID="lblDateCheck" runat="server" />
