<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewGrid.ascx.cs" Inherits="bhattji.Modules.XYZ70s.ViewGrid" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewGrid" DataSourceID="odsXYZ70s" 
