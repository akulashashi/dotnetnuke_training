...
{
    [Serializable]
    [TableName("bhattji_XYZ70Categories")]
    [PrimaryKey("ItemId")]
    public class CategoryInfo
    {
        ...
        [Ignore]public string ViewOrderString { get { return ViewOrder.HasValue ? ViewOrder.ToString() : string.Empty; } set { try { if (!string.IsNullOrEmpty((value))) ViewOrder = Convert.ToInt32(value); } catch { } } }
    ...
    public class CategoriesController : CommonControllerMethods
    {
        ...
        private StringBuilder GetSearchSql(string SearchText, bool StartsWith, int ModuleId, int PortalId, int CategoriesScope)
        {
            ...
            sbSql.Append("FROM " + GetDboName("XYZ70Categories") + " AS x ");
        ...
        {
            return Convert.ToInt32(db.Insert(GetDboName("XYZ70Categories"), "ItemId", objCategory));
        }
        public int UpdateCategory(CategoryInfo objCategory)
        {
            return db.Update(GetDboName("XYZ70Categories"), "ItemId", objCategory);
        }
        public int DeleteCategory(CategoryInfo objCategory)
        {
            return db.Delete(GetDboName("XYZ70Categories"), "ItemId", objCategory);
        }
        public int DeleteCategory(int ItemID)
        {
            return db.Delete(GetDboName("XYZ70Categories"), "ItemId", null, ItemID);
        }
        ...
        public int GetCategoryId(string Category)
        {
            ...
            sbSql.Append("FROM " + GetDboName("XYZ70Categories") + " ");
        ...
        public IEnumerable<XYZ70Info> GetSearchedCategories()
        {
        ...
        {
            //DataProvider.Instance().ExecuteNonQuery(PrefixCompanyID("SetViewOrderXYZ70Categories"), ModuleID);
            string strSP = ";EXEC " + GetDboName("SetViewOrderXYZ70Categories") + " @0";
            return db.Execute(strSP, ModuleID);
        }
        public int ClaimOrphanCategories(int ModuleID)
        {
            //DataProvider.Instance().ExecuteNonQuery(PrefixCompanyID("ClaimOrphanXYZ70Categories"), ModuleID);
            string strSP = ";EXEC " + GetDboName("ClaimOrphanXYZ70Categories") + " @0";
            return db.Execute(strSP, ModuleID);
        }
