<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditItem.ascx.cs" Inherits="bhattji.Modules.Html5Medias.EditItem" %>
...
<div class="dnnForm" id="frmEditItem">
    <fieldset>
        <div class="dnnFormItem">
            ...
            <asp:RequiredFieldValidator ID="valTitle" ControlToValidate="txtTitle" ErrorMessage="You Must Enter A Title For The Html5Media" resourcekey="Title.ErrorMessage" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" runat="server" />
        </div>
        <div class="dnnFormItem">
        ...
        <div class="dnnFormItem">
            ...
            <asp:RequiredFieldValidator ID="valDescription" resourcekey="Description.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="teDescription" ErrorMessage="You Must Enter A Description Of The Html5Media" Display="Dynamic" />
        </div>
        <div class="dnnFormItem">
        ...
        <div class="dnnFormItem">
            ...
            <asp:RequiredFieldValidator ID="valDetails" resourcekey="Details.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="teDetails" ErrorMessage="You Must Enter A Details Of The Html5Media" Display="Dynamic" />
        </div>
        <div class="dnnFormItem">
...
<table width="560" cellspacing="0" cellpadding="0" border="0" summary="Edit Html5Medias Design Table">
    <tr class="dnnForm">
