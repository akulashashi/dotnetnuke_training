...
namespace bhattji.Modules.Html5Medias
{
    ...
    public static class IDataReaderHelper
    {
        ...
        //public static List<Html5MediaInfo> ToLOT(IDataReader thisDR)
        public static List<Html5MediaInfo> ToLOT(this IDataReader thisDR)
        {
            return CBO.FillCollection<Html5MediaInfo>(thisDR);
        }

        //public static List<Html5MediaInfo> ToLOT(IDataReader thisDR)
        public static List<Html5MediaInfo> ToLOT(this IDataReader thisDR, ref int totalRecords)
        {
            return CBO.FillCollection<Html5MediaInfo>(thisDR, ref totalRecords);
        }

        //public static List<Html5MediaInfo> ToLOT(IDataReader thisDR, ref IList<Html5MediaInfo> objToFill)
        public static IList<Html5MediaInfo> ToLOT(this IDataReader thisDR, ref IList<Html5MediaInfo> objToFill)
        {
            return CBO.FillCollection<Html5MediaInfo>(thisDR, ref objToFill);
        }
    }
