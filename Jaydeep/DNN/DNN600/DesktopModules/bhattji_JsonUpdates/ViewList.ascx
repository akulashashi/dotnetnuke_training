<%@ Control Language="C#" AutoEventWireup="true" Codebehind="ViewList.ascx.cs" Inherits="bhattji.Modules.JsonUpdates.ViewList" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewList" DataSourceID="odsJsonUpdates" 
    runat="server" AllowPaging="True" AllowSorting="True" 
    AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="100%" 
    EmptyDataText="<center class='NormalRed'>No JsonUpdate Defined</center>" 
    ...
    <EmptyDataTemplate>
        <p class="NormalRed" align="center">No JsonUpdate Defined<br />
...
<asp:ObjectDataSource ID="odsJsonUpdates" runat="server" />
