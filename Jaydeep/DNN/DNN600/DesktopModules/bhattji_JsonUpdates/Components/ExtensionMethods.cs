...
namespace bhattji.Modules.JsonUpdates
{
    ...
    public static class IDataReaderHelper
    {
        ...
        //public static List<JsonUpdateInfo> ToLOT(IDataReader thisDR)
        public static List<JsonUpdateInfo> ToLOT(this IDataReader thisDR)
        {
            return CBO.FillCollection<JsonUpdateInfo>(thisDR);
        }

        //public static List<JsonUpdateInfo> ToLOT(IDataReader thisDR)
        public static List<JsonUpdateInfo> ToLOT(this IDataReader thisDR, ref int totalRecords)
        {
            return CBO.FillCollection<JsonUpdateInfo>(thisDR, ref totalRecords);
        }

        //public static List<JsonUpdateInfo> ToLOT(IDataReader thisDR, ref IList<JsonUpdateInfo> objToFill)
        public static IList<JsonUpdateInfo> ToLOT(this IDataReader thisDR, ref IList<JsonUpdateInfo> objToFill)
        {
            return CBO.FillCollection<JsonUpdateInfo>(thisDR, ref objToFill);
        }
    }
    ...
    /// <summary>
    /// Summary description for IEnumerableHelper
    /// </summary>
