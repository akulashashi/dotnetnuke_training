<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewCategories.ascx.cs" Inherits="bhattji.Modules.XYZ60s.ViewCategories" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<div class="dnnLeft">
    <div id="divManageCategories" runat="server">
        <asp:GridView ID="gdvCategories" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId,ModuleId" GridLines="None" EmptyDataText="<center class='NormalRed'>No XYZ60 Category Defined</center>" CssClass="dnnGrid" Width="100%">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
            ...
            <EmptyDataTemplate>
                <p class="NormalRed" align="center">No XYZ60 Category Defined<br />
        ...
        <div class="dnnForm" id="frmAddCategory">
            <fieldset>
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:RequiredFieldValidator ID="valCategory" ControlToValidate="txtCategory" ErrorMessage="You Must Enter A Category For The XYZ60" ResourceKey="Category.ErrorMessage" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" runat="server" />
                </div>
                <div class="dnnFormItem">
