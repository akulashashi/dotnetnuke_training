<%@ Control Language="C#" AutoEventWireup="true" Codebehind="ViewJukes.ascx.cs"  Inherits="bhattji.Modules.XYZ60s.ViewJukes" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewJukes" DataSourceID="odsXYZ60s" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="100%" EmptyDataText="<center class='NormalRed'>No XYZ60 Defined</center>" CssClass="dnnGrid">
    <Columns>
