<%@ Control Language="C#" AutoEventWireup="true" Codebehind="Details.ascx.cs" Inherits="bhattji.Modules.XYZ60s.Details" %>
...
<table width="100%">
	...
	<tr>
		<td colspan="2">
			...
			<asp:PlaceHolder id="phtXYZ60Details" runat="server" />
