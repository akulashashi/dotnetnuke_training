<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewGrid.ascx.cs" Inherits="bhattji.Modules.XYZ60s.ViewGrid" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewGrid" DataSourceID="odsXYZ60s" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="Title">
            <ItemTemplate>
							<asp:PlaceHolder id="phtXYZ60Description" runat="server" />&nbsp;
