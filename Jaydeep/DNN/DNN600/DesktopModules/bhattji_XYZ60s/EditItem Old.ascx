                ...
                <tr>
                    <td class="SubHead" colspan="2">
                        <div id="divDescription" runat="server">
                            ...
                            <br />
                            <asp:RequiredFieldValidator ID="valDescription" resourcekey="Description.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="teDescription" ErrorMessage="You Must Enter A Description Of The XYZ60" Display="Dynamic" /><%--<act:validatorcalloutextender runat="Server" id="vlxDescription" targetcontrolid="valDescription" highlightcssclass="CustomValidatorCalloutStyle" />--%>
                        </div>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td class="SubHead" colspan="2">
                        <div id="divDetails" runat="server">
                            ...
                            <br />
                            <asp:RequiredFieldValidator ID="valDetails" resourcekey="Details.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="teDetails" ErrorMessage="You Must Enter A Details Of The XYZ60" Display="Dynamic" /><%--<act:validatorcalloutextender runat="Server" id="vlxDetails" targetcontrolid="valDetails" highlightcssclass="CustomValidatorCalloutStyle" />--%>
                        </div>
                    </td>
                </tr>
                <tr>
