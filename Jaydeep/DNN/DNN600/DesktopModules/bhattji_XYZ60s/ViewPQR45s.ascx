<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewPQR45s.ascx.cs" Inherits="bhattji.Modules.XYZ60s.ViewPQR45s" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<div class="dnnLeft">
    <div id="divManagePQR45s" runat="server">
        <asp:GridView ID="gdvPQR45s" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId,XYZ60Id" GridLines="None" EmptyDataText="<center class='NormalRed'>No XYZ60 PQR45 Defined</center>" CssClass="dnnGrid">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                ...
                <asp:BoundField DataField="XYZ60Title" HeaderText="XYZ60Title" SortExpression="XYZ60Title" ReadOnly="True" />
            ...
            <EmptyDataTemplate>
                <p class="NormalRed" align="center">No XYZ60 PQR45 Defined<br />
        ...
        <div class="dnnForm" id="frmAddCategory">
            <fieldset>
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:RequiredFieldValidator ID="valPQR45" ControlToValidate="txtPQR45" ErrorMessage="You Must Enter A PQR45 For The XYZ60" ResourceKey="PQR45.ErrorMessage" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" runat="server" />
                </div>
                <div class="dnnFormItem">
