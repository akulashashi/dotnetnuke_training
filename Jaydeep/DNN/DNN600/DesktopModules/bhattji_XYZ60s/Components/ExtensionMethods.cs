...
namespace bhattji.Modules.XYZ60s
{
    ...
    public static class IDataReaderHelper
    {
        ...
        //public static List<XYZ60Info> ToLOT(IDataReader thisDR)
        public static List<XYZ60Info> ToLOT(this IDataReader thisDR)
        {
            return CBO.FillCollection<XYZ60Info>(thisDR);
        }

        //public static List<XYZ60Info> ToLOT(IDataReader thisDR)
        public static List<XYZ60Info> ToLOT(this IDataReader thisDR, ref int totalRecords)
        {
            return CBO.FillCollection<XYZ60Info>(thisDR, ref totalRecords);
        }

        //public static List<XYZ60Info> ToLOT(IDataReader thisDR, ref IList<XYZ60Info> objToFill)
        public static IList<XYZ60Info> ToLOT(this IDataReader thisDR, ref IList<XYZ60Info> objToFill)
        {
            return CBO.FillCollection<XYZ60Info>(thisDR, ref objToFill);
        }
    }
