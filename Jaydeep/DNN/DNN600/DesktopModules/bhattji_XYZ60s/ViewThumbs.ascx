<%@ Control Language="C#"  AutoEventWireup="true" CodeBehind="ViewThumbs.ascx.cs" Inherits="bhattji.Modules.XYZ60s.ViewThumbs" %>
...
<%= GetMarquee() %><asp:DataList ID="lstViewThumbs" runat="server" 
    Summary="XYZ60 Thumbnails Design Table" RepeatColumns="5" GridLines="None" 
    Width="100%" CssClass="dnnGrid">  <%--DataSourceID="odsXYZ60s"--%>
    <ItemTemplate>
        ...
        <asp:PlaceHolder ID="phtXYZ60Description" runat="server" /><br />
