<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewCat.ascx.cs" Inherits="bhattji.Modules.XYZ60s.ViewCat" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewCat" DataSourceID="odsXYZ60s" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="100%" EmptyDataText="<center class='NormalRed'>No XYZ60 Defined</center>" CssClass="dnnGrid">
    <Columns>
        ...
        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="Title">
            <ItemTemplate>
							...
							<asp:PlaceHolder id="phtXYZ60Description" runat="server" />&nbsp;<asp:HyperLink id="hypMoreLink" CssClass="Normal" ResourceKey="ReadMore" runat="server" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
    <EmptyDataTemplate>
