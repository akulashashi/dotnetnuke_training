<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="bhattji.Modules.XYZ60s.Settings" %>
...
<div class="dnnForm" id="frmSettings">
    ...
    <fieldset class="dnnClear">
        ...
        <div class="dnnFormItem">
            ...
            <table>
                <tr>
                    <td><dnn:Label id="plPagerSize" ControlName="txtPagerSize" Suffix=":" runat="server" /></td>
                    ...
                    <td><dnn:Label id="plNoOfPages" ControlName="txtNoOfPages" Suffix=":" runat="server" /></td>
        ...
        <div class="dnnFormItem">
            <dnn:Label id="plPQR45PagerSize" ControlName="txtPQR45PagerSize" Suffix=":" runat="server" />
            <asp:TextBox ID="txtPQR45PagerSize" runat="server" />
        </div>
        <div class="dnnFormItem">
