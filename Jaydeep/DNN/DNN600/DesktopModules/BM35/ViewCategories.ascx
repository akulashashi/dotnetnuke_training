...
<div class="dnnLeft">
    <div id="divManageCategories" runat="server">
        <asp:GridView ID="gdvCategories" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId,ModuleId" GridLines="None" EmptyDataText="<center class='NormalRed'>No XYZ70 Category Defined</center>" CssClass="dnnGrid" Width="100%">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
