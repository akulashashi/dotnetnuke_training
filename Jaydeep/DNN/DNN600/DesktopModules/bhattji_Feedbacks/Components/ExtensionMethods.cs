...
namespace bhattji.Modules.Feedbacks
{
    ...
    public static class IDataReaderHelper
    {
        ...
        //public static List<FeedbackInfo> ToLOT(IDataReader thisDR)
        public static List<FeedbackInfo> ToLOT(this IDataReader thisDR)
        {
            return CBO.FillCollection<FeedbackInfo>(thisDR);
        }

        //public static List<FeedbackInfo> ToLOT(IDataReader thisDR)
        public static List<FeedbackInfo> ToLOT(this IDataReader thisDR, ref int totalRecords)
        {
            return CBO.FillCollection<FeedbackInfo>(thisDR, ref totalRecords);
        }

        //public static List<FeedbackInfo> ToLOT(IDataReader thisDR, ref IList<FeedbackInfo> objToFill)
        public static IList<FeedbackInfo> ToLOT(this IDataReader thisDR, ref IList<FeedbackInfo> objToFill)
        {
            return CBO.FillCollection<FeedbackInfo>(thisDR, ref objToFill);
        }
    }
