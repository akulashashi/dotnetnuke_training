    ...
    <div id="tabBasic" class="dnnClear">
        <fieldset>
            <div class="dnnFormItem">
                ...
                <asp:RequiredFieldValidator ID="valTitle" ControlToValidate="txtTitle" ErrorMessage="You Must Enter A Title For The Feedback" resourcekey="Title.ErrorMessage" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" runat="server" />
            </div>
            <div class="dnnFormItem">
        ...
        <fieldset>
            ...
            <div class="dnnFormItem">
                ...
                <div class="dnnLeft">
                    ...
                    <asp:RequiredFieldValidator ID="valDescription" resourcekey="Description.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="teDescription" ErrorMessage="You Must Enter A Description Of The Feedback" Display="Dynamic" />
                </div>
            </div>
        </fieldset>
    </div>
        ...
        <fieldset>
            <div class="dnnFormItem">
                ...
                <div class="dnnLeft">
                    ...
                    <asp:RequiredFieldValidator ID="valDetails" resourcekey="Details.ErrorMessage" runat="server" CssClass="dnnFormMessage dnnFormError" ControlToValidate="teDetails" ErrorMessage="You Must Enter A Details Of The Feedback" Display="Dynamic" />
                </div>
            </div>
            <div class="dnnFormItem">
