...
namespace bhattji.Modules.Trackings
{
    ...
    public static class IDataReaderHelper
    {
        ...
        //public static List<TrackingInfo> ToLOT(IDataReader thisDR)
        public static List<TrackingInfo> ToLOT(this IDataReader thisDR)
        {
            return CBO.FillCollection<TrackingInfo>(thisDR);
        }

        //public static List<TrackingInfo> ToLOT(IDataReader thisDR)
        public static List<TrackingInfo> ToLOT(this IDataReader thisDR, ref int totalRecords)
        {
            return CBO.FillCollection<TrackingInfo>(thisDR, ref totalRecords);
        }

        //public static List<TrackingInfo> ToLOT(IDataReader thisDR, ref IList<TrackingInfo> objToFill)
        public static IList<TrackingInfo> ToLOT(this IDataReader thisDR, ref IList<TrackingInfo> objToFill)
        {
            return CBO.FillCollection<TrackingInfo>(thisDR, ref objToFill);
        }
    }
