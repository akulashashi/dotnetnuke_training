...
namespace bhattji.Modules.VimeoVideos
{
    ...
    public static class IDataReaderHelper
    {
        ...
        //public static List<VimeoVideoInfo> ToLOT(IDataReader thisDR)
        public static List<VimeoVideoInfo> ToLOT(this IDataReader thisDR)
        {
            return CBO.FillCollection<VimeoVideoInfo>(thisDR);
        }

        //public static List<VimeoVideoInfo> ToLOT(IDataReader thisDR)
        public static List<VimeoVideoInfo> ToLOT(this IDataReader thisDR, ref int totalRecords)
        {
            return CBO.FillCollection<VimeoVideoInfo>(thisDR, ref totalRecords);
        }

        //public static List<VimeoVideoInfo> ToLOT(IDataReader thisDR, ref IList<VimeoVideoInfo> objToFill)
        public static IList<VimeoVideoInfo> ToLOT(this IDataReader thisDR, ref IList<VimeoVideoInfo> objToFill)
        {
            return CBO.FillCollection<VimeoVideoInfo>(thisDR, ref objToFill);
        }
    }
