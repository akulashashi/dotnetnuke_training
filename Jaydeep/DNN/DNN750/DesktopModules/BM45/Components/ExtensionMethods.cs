...
namespace bhattji.Modules.XYZ70s
{
    public static class StringHelper
    {
        ...
        public static object ToScalar(this string thisString, string ConnString)
        {
            SqlConnection conn = new SqlConnection(ConnString);
            conn.Open();
            return new SqlCommand(thisString, conn).ExecuteScalar();

        }
        public static IDataReader ToIDataReader(this string thisString, string ConnString)
        {
            SqlConnection conn = new SqlConnection(ConnString);
            conn.Open();
            return new SqlCommand(thisString, conn).ExecuteReader();
            
        }
        public static DataTable ToDataTable(this string thisString, string ConnString) 
        {
            SqlConnection conn = new SqlConnection(ConnString);
            conn.Open();
            IDataReader dr = new SqlCommand(thisString, conn).ExecuteReader();
            DataTable dt = new DataTable();
            dt.Load(dr);
            conn.Close();
            return dt;
        }
        public static OleDbDataReader FromCsvTxt2DR(this string thisString)
        {           
            string strConn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + System.Web.HttpContext.Current.Server.MapPath(System.IO.Path.GetDirectoryName(thisString)) + ";Extended Properties=\"Text;HDR=Yes;IMEX=1\"";
            string strCmd = "SELECT * FROM " + thisString;
        ...
        public static OleDbDataReader FromXls2DR(this string thisString)
        {
            string strConn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + System.Web.HttpContext.Current.Server.MapPath(thisString) + ";Extended Properties=\"Excel 8.0;HDR=Yes;IMEX=1\"";
    ...
    public static class DataTableHelper
    {
        ...
        public static void Load(this DataTable thisDT, string XlsCsvTxtXmlFile, string TableName)
        {
            ...
            //        OleDbDataAdapter da = new OleDbDataAdapter(strCmd, strConn);
            //        da.Fill(thisDT);
            //    }
            //}
            //catch
    ...
    public static class IDataReaderHelper
    {
        ...
        //public static List<XYZ70Info> ToLOT(IDataReader thisDR)
        public static List<XYZ70Info> ToLOT(this IDataReader thisDR)
        {
            return CBO.FillCollection<XYZ70Info>(thisDR);
        }

        //public static List<XYZ70Info> ToLOT(IDataReader thisDR)
        public static List<XYZ70Info> ToLOT(this IDataReader thisDR, ref int totalRecords)
        {
            return CBO.FillCollection<XYZ70Info>(thisDR, ref totalRecords);
        }

        //public static List<XYZ70Info> ToLOT(IDataReader thisDR, ref IList<XYZ70Info> objToFill)
        public static IList<XYZ70Info> ToLOT(this IDataReader thisDR, ref IList<XYZ70Info> objToFill)
        {
            return CBO.FillCollection<XYZ70Info>(thisDR, ref objToFill);
        }
    }

    /// <summary>
    /// Summary description for IListHelper
    /// </summary>
