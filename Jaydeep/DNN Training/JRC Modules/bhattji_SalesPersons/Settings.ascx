<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Settings.ascx.vb" Inherits="bhattji.Modules.SalesPersons.Settings" %>
<%@ Register TagPrefix="Portal" TagName="Audit" Src="../../controls/ModuleAuditControl.ascx" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<%@ Register TagPrefix="dnn" TagName="SectionHead" Src="~/controls/SectionHeadControl.ascx" %>
<%@ Register TagPrefix="Portal" TagName="URL" Src="~/controls/URLControl.ascx" %>
<table width="560" cellspacing="0" cellpadding="0" border="0" summary="Edit SalesPersons Settings Table">
	<tr>
	...
	<tr>
		<td class="SubHead"><dnn:label id="plCombined" runat="server" Controlname="rblCombined" suffix=":" /></td>
		<td class="Normal">
			<asp:radiobuttonlist id="rblCombined" cssclass="NormalTextBox" repeatdirection="Horizontal" runat="server">
			    <asp:listitem value="CompleteUnique" resourcekey="CompleteUnique" />
				<asp:listitem value="CodeOnly" resourcekey="CodeOnly" />
				<asp:listitem value="Combined" resourcekey="Combined" />
	...
	<tr>
		...
		<td class="Normal">
			<asp:radiobuttonlist id="rblViewControl" runat="server" cssclass="NormalTextBox" repeatdirection="Horizontal">
				...
				<asp:listitem value="Personal" resourcekey="Personal" />
				<asp:listitem value="Termination" resourcekey="Termination" />
			</asp:radiobuttonlist>
		</td>
	</tr>
	<tr>
		<td class="SubHead"><dnn:label id="plAdminView" controlname="chkAdminView" suffix=":" runat="server" /></td>
		<td class="Normal"><asp:checkbox ID="chkAdminView" resourcekey="AdminView" TextAlign="Right" runat="server" /></td>
	</tr>
	<tr>
		<td class="SubHead"><dnn:label id="plDispatcherEdit" controlname="chkDispatcherEdit" suffix=":" runat="server" /></td>
		<td class="Normal"><asp:checkbox ID="chkDispatcherEdit" resourcekey="DispatcherEdit" TextAlign="Right" runat="server" /></td>
	</tr>
	<tr>
