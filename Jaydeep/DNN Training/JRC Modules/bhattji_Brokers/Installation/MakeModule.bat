...
@REM * Change to the Path where c:\DNN\JRC45\DesktopModules\bhattji_Brokers\Installation is Installed *
CD\DNN\JRC45\DesktopModules\bhattji_Brokers\Installation
