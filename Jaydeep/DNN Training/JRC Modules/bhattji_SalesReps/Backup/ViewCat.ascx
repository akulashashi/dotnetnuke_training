<%@ Control Language="c#" AutoEventWireup="true" Inherits="bhattji.Modules.SalesReps.ViewCat" CodeBehind="ViewCat.ascx.cs" AutoEventWireup="false" Explicit="True" %>
...
<%= GetMarquee() %><asp:GridView ID="gdvViewCat" DataSourceID="odsSalesReps" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="100%" EmptyDataText="<center class='NormalRed'>No SalesRep Defined</center>">
    <Columns>
        ...
        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" SortExpression="Title">
            <ItemTemplate>
							...
							<asp:placeholder id="phtSalesRepDescription" runat="server" />&nbsp;<asp:hyperlink id="hypMoreLink" CssClass="Normal" resourcekey="ReadMore" runat="server" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
    <EmptyDataTemplate>
