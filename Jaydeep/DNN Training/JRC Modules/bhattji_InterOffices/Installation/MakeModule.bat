...
@REM * Change to the Path where C:\DNN\JRC45\DesktopModules\bhattji_InterOffices\Installation is Installed *
CD\DNN\JRC45\DesktopModules\bhattji_InterOffices\Installation
