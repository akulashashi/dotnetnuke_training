<%@ Control Language="vb" Inherits="bhattji.Modules.LoadSheets.EditLoadDrops" CodeBehind="Copy (22-03-2010) EditLoadDrops.ascx.vb" AutoEventWireup="False" Explicit="True" %>
...
<table id="tblAddLoadDrop" border="0" cellspacing="1" cellpadding="1" class="boxdisplay" Width="375" runat="server">
    <tr>
        <td class="SubHead" colspan="2">
            <table>
                <tr>
                    <td nowrap><dnn:Label ID="plDPCity" ControlName="txtDPCity" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtDPCity" Columns="22" CssClass="NormalTextBox" runat="server" AutoPostBack="true" />
                    <act:AutoCompleteExtender ID="aceDPCity"  MinimumPrefixLength="1" ServicePath="~/DesktopModules/bhattji.LoadSheets/WebService.asmx" ServiceMethod="GetCityNames" runat="server" TargetControlID="txtDPCity" CompletionListCssClass="CompletionListCssClass" CompletionListItemCssClass="CompletionListItemCssClass" CompletionListHighlightedItemCssClass="CompletionListHighlightedItemCssClass" CompletionSetCount="25" EnableCaching="true" />
                    </td>
    ...
    <tr id="trAdditionalInfo" runat="server">
        ...
        <td class="SubHead" valign="top"><dnn:Label ID="plJobno" ControlName="txtJobno" Suffix=":" CssClass="SubHead" runat="server" /> <asp:TextBox ID="txtJobno" CssClass="NormalTextBox" runat="server" /><br />
            ...
            <table>
            <tr><td colspan="2"><dnn:Label ID="plBOLSeq" ControlName="txtBOLSeq" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtBOLSeq" CssClass="NormalTextBox" runat="server" MaxLength="30" /></td></tr>
            <tr><td><dnn:Label ID="plStime" ControlName="txtStime" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtStime" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="6" /></td><td align="right"><dnn:Label ID="plEtime" ControlName="txtEtime" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtEtime" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="6" /></td></tr>
...
<div class="reorderListDemo" id="divLoadDPs" runat="server">
    <asp:GridView ID="gdvLoadDrops" DataSourceID="odsLoadDrops" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="375" EmptyDataText="<center class='NormalRed'>No Load-Drop Defined</center>">
        <Columns>
            ...
            <asp:TemplateField HeaderText="<nobr>City / State / Zip</nobr>" HeaderStyle-CssClass="jrctitletext" ItemStyle-VerticalAlign="Top">
                <ItemTemplate>
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr><td nowrap style="width:16px"><dnn:SectionHead ID="secMoreInfo1" CssClass="SubHead" Section="trMoreInfo1" ResourceKey="secMoreInfo1" Text="" IncludeRule="True" IsExpanded="false" runat="server" /></td><td nowrap><asp:Label ID="lblSeq" runat="server" CssClass="DisplayNone" Text='<%# Eval("Seq") %>' /><asp:Label ID="lblDPCity" CssClass="Normal" Style="background-color: #FFFFA0; color: #000000" runat="server" Text='<%# Eval("DPCity") %>' />/<asp:Label ID="lblDPState" CssClass="Normal" Style="background-color: #FFFFA0; color: #000000" runat="server" Text='<%# Eval("DPState") %>' />/<asp:Label ID="lblZipCode" CssClass="Normal" Style="background-color: #FFFFA0; color: #000000" runat="server" Text='<%# Eval("ZipCode") %>' /></td></tr>
                        <tr id="trMoreInfo1" runat="server"><td colspan="2"><asp:Label ID="lblAdditional" runat="server" CssClass="Normal" /></td></tr>
                    </table>
                </ItemTemplate>
            </asp:TemplateField>
