...
<center>
    ...
    <table id="jrcbrokertable" runat="server" class="boxdisplay" style="display:none">
        <tr>
                            ...
                            <tr>
                                <td>
                                    <table id="tblBroker" runat="server">
                                        <tr>
                                            <td><asp:Label ID="Label2" Text="Broker" CssClass="SubHead" runat="server" /></td>
                                            <td><nobr><asp:TextBox ID="txtBrokerCode" runat="server" CssClass="NormalTextBox" Width="325" /><asp:ImageButton ID="btnBrokerSearch" ImageUrl="~/images/view.gif" runat="server" CausesValidation="False" /></nobr>
                                                <asp:DropDownList ID="ddlBrokerCode" runat="server" CssClass="NormalTextBox" AutoPostBack="True" Width="325"><asp:ListItem Value="0000000" Text="No Broker" /></asp:DropDownList></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" class="Normal"><asp:Label ID="lblBroker" runat="server" CssClass="NormalBold" /></td>
                                        </tr>
                                    </table>
                               </td>
                            </tr>
