<%@ Control Language="vb" Inherits="bhattji.Modules.LoadSheets.rvXmission" CodeBehind="rvXmission.ascx.vb" AutoEventWireup="False" Explicit="True" %>
<%--
        ...
        <td>
            <table width="100%">
                <tr>
                    ...
                    <td><asp:Label ID="lblXmissionFile" Text="XmissionFile" CssClass="SubHead" runat="server" /><br />
                    ...
                    <td style="display: none"><asp:Label ID="plSort" Text="Sort" CssClass="SubHead" runat="server" /><br />
                        <asp:DropDownList ID="ddlSort" runat="server" CssClass="NormalTextBox" AutoPostBack="true">
                            <asp:ListItem Value="XMissionDate" Text="XMissionDate" />
                            <asp:ListItem Value="LoadDate" Text="Load Date" />
                            <asp:ListItem Value="BCustBill" Text="Billing" />
                    ...
                    <td nowrap colspan="2" align="right" class="DisplayNone"><asp:HyperLink ID="hyprvXmission" resourcekey="hyprvXmission" ImageUrl="~/images/print_this.png" NavigateUrl='<%# EditUrl("ReportType", "ReportXmission", "Reports", "dnnprintmode=true&SkinSrc=%5BG%5D%2fskins%2f_default%2fno%20skin&ContainerSrc=%5BG%5D%2fcontainers%2f_default%2fno%20container") %>' Target="_blank" runat="server" /></td>
                </tr>
            </table>
        </td>
    </tr>
