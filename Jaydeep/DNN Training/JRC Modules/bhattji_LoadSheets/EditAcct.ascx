                    ...
                    <tr>
                        <td width="70" align="center" valign="top" class="DisplayNone">
                            <asp:UpdateProgress ID="UpdateProgress3" runat="server">
                                <ProgressTemplate>
                                    <asp:Image ID="Image3" ImageUrl="~/images/dnnanim.gif" runat="server" />                                </ProgressTemplate>
                            </asp:UpdateProgress>
                        ...
                        <td class="menu32" valign="middle"></td>
                        <td class="menu32"></td>
...
<table class="boxdisplay">
	...
	<tr>
		<td width="320">
					<div class="SubHead nowrap-l"><asp:Label ID="lblBBaseLoad" resourcekey="plBBaseLoad" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBBaseLoad" CssClass="custbilldol" runat="server" Columns="8" /><act:FilteredTextBoxExtender ID="fteBBaseLoad" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBBaseLoad" ValidChars="+-." />
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblDiscountPCT" resourcekey="plDiscountPCT" CssClass="custbilldol" runat="server"/> <asp:CheckBox ID="chkFixedDiscount" Text="%" TextAlign="Left" CssClass="custbilldol" runat="server" AutoPostBack="true" /></div>
					<div class="nowrap"><asp:TextBox ID="txtDiscountPCT" CssClass="custbilldol" runat="server" Columns="1" /><act:FilteredTextBoxExtender ID="fteDiscountPCT" runat="server" FilterType="Numbers, Custom" TargetControlID="txtDiscountPCT" ValidChars="+-."/> 
						<asp:TextBox ID="txtDiscountDlr" CssClass="custbilldol" runat="server" Columns="7" /><act:FilteredTextBoxExtender ID="fteDiscountDlr" runat="server" FilterType="Numbers, Custom" TargetControlID="txtDiscountDlr" ValidChars="+-." /></div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBDeten" resourcekey="plBDeten" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBDeten" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBDeten" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBDeten" ValidChars="+-." />
						<asp:CheckBox ID="chkBINC3" resourcekey="chkBINC3" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBTolls" resourcekey="plBTolls" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBTolls" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBTolls" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBTolls" ValidChars="+-." />
						<asp:CheckBox ID="chkBINC4" resourcekey="chkBINC4" CssClass="Normal" runat="server" Checked="True"/>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBFuel" resourcekey="plBFuel" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBFuel" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBFuel" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBFuel" ValidChars="+-.">
					</act:FilteredTextBoxExtender>
						<asp:CheckBox ID="chkBINC5" resourcekey="chkBINC5" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBDrop" resourcekey="plBDrop" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBDrop" CssClass="custbilldol" runat="server" Columns="7" /><act:FilteredTextBoxExtender ID="fteBDrop" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBDrop" ValidChars="+-.">
					</act:FilteredTextBoxExtender>
						<asp:CheckBox ID="chkBINC6" resourcekey="chkBINC6" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBRecon" resourcekey="plBRecon" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBRecon" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBRecon" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBRecon" ValidChars="+-.">
					</act:FilteredTextBoxExtender>
						<asp:CheckBox ID="chkBINC7" resourcekey="chkBINC7" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBTarp" resourcekey="plBTarp" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBTarp" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBTarp" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBTarp" ValidChars="+-.">
					</act:FilteredTextBoxExtender>
						<asp:CheckBox ID="chkBINC8" resourcekey="chkBINC8" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBLumper" resourcekey="plBLumper" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBLumper" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBLumper" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBLumper" ValidChars="+-.">
					</act:FilteredTextBoxExtender>
						<asp:CheckBox ID="chkBINC9" resourcekey="chkBINC9" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBUnload" resourcekey="plBUnload" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBUnload" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBUnload" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBUnload" ValidChars="+-.">
					</act:FilteredTextBoxExtender>
						<asp:CheckBox ID="chkBINC10" resourcekey="chkBINC10" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBAdminMisc" resourcekey="plBAdminMisc" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBAdminMisc" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBAdminMisc" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBAdminMisc" ValidChars="+-.">
					</act:FilteredTextBoxExtender>
						<asp:CheckBox ID="chkBINC11" resourcekey="chkBINC11" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
					</div>
				
					<div class="SubHead nowrap-l"><asp:Label ID="lblBCustBill" resourcekey="plBCustBill" CssClass="custbilldol" runat="server"></asp:Label></div>
					<div class="nowrap"><asp:TextBox ID="txtBCustBill" CssClass="NormalTextBox NumericTextBox ReadOnlyTextBox" Style="font-weight: bold; border: none; text-align: right;" runat="server" Columns="13" ReadOnly="True" />&nbsp;<asp:ImageButton ID="imbCalculate" runat="server" ImageUrl="~/images/accounting_small.png" Visible="False" />
					</div>
...
<table id="tblBroker" runat="server" class="boxdisplay">
			...
			<table style="width: 255px">
				<tr>
					...
					<div class="jrctitletext fleft">
					    <span class="col60per">&nbsp; Broker &nbsp;</span><span class="col40per"><asp:CheckBox ID="chkBKFixed" resourcekey="chkBKFixed" CssClass="fixed" Text="Fixed $" runat="server" AutoPostBack="True" Checked="True" /></span>
					</div>
					<%--<table><tr>
					    <td class="col60per"></td>
					    <td class="col40per"></td>
					    <td class="col40per"></td>
					</tr></table>--%>					
					</td>
				</tr>
				...
				<tr>
					...
					<asp:CheckBox ID="chkAllowZeroBkrPct" resourcekey="chkAllowZeroBkrPct" CssClass="NormalBold" Text="0 %Comm" runat="server" AutoPostBack="True" />
					</td>
	...
	<tr>
		<td width="255">
			<div class="jrctitletext">&nbsp; I/O Office &nbsp;</div>
			<div><asp:Label ID="lblIOCode" runat="server" CssClass="NormalBold" /> &nbsp; <asp:Label ID="lblIOName" runat="server" CssClass="NormalBold" /></div>
			<table>
			<tr>
								<td>
						<div class="fleft">
								<div class="col25"><asp:Label ID="lblIoPct" CssClass="NormalBold" runat="server">%</asp:Label></div>
								<div class="col25 DisplayNone"><asp:Label ID="lblIOFixed" CssClass="SubHead" runat="server" Text="Fixed$" /></div>
								<div class="col25"><asp:Label ID="lblIoDlr" CssClass="NormalBold" runat="server" Text="I/O Comm $" /></div>
								<div class="col25 DisplayNone"><asp:Label ID="lblNet" CssClass="NormalBold" runat="server" Text="Net$" /></div>
							</div>
						<div class="fleft">
								<div class="col25"><asp:TextBox ID="txtIOPct" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="4" /><act:FilteredTextBoxExtender ID="fteIOPct" runat="server" FilterType="Numbers, Custom" TargetControlID="txtIOPct" ValidChars="+-." /></div>
								<div class="col25 DisplayNone"><asp:CheckBox ID="chkIOFixed" resourcekey="chkIOFixed" CssClass="Normal" runat="server" AutoPostBack="True" /></div>
								<div class="col25"><asp:TextBox ID="txtIODlr" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="8" /><act:FilteredTextBoxExtender ID="fteIODlr" runat="server" FilterType="Numbers, Custom" TargetControlID="txtIODlr" ValidChars="+-." /></div>
								<div class="col25 DisplayNone"><asp:TextBox ID="txtNetIODlr" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="8" /><act:FilteredTextBoxExtender ID="fteNetIODlr" runat="server" FilterType="Numbers, Custom" TargetControlID="txtNetIODlr" ValidChars="+-." /></div>
						</div>
					</td>
				</tr>
			</table>
		...
		<td width="255">
			<table width="100%">
				<tr>
					<td colspan="4">
						<div class="jrctitletext fleft">
							<div class="col60per">&nbsp; Driver &nbsp;</div>
							<div class="col40per"><asp:CheckBox ID="chkOOFixed" runat="server" AutoPostBack="True" CssClass="fixed" resourcekey="chkOOFixed" Checked="False" /></div>
						</div>
					</td>
				</tr>
				<tr>
		...
		<td>
			...
			<table id="tblCommissionsSplit3" runat="server" style="width: 255px">
				...
				<tr>
					...
					<td><asp:TextBox ID="txtIOComm3" runat="server" Columns="4" CssClass="NormalTextBox NumericTextBox" ReadOnly="true" /><asp:TextBox ID="txtIOComm3a" runat="server" Columns="4" CssClass="NormalTextBox NumericTextBox" ReadOnly="true" /></td>
				</tr>
			</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr id="trAdjustJrcTotal" runat="server">
		<td bgcolor="#D2FFD2" cssclass="alloc_amt"><asp:CheckBox ID="chkAdjustJrcTotal" CssClass="alloc_amt" runat="server" Text="Click this box to adjust your commission, then re-calculate." /></td>
	</tr>
</table>
<table id="tblAccountingNegative" runat="server" visible="false" width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr><td>
	<asp:Label ID="lblAccountingNegativeHeading" runat="server" CssClass="NormalRed" Text="Accounting contains negative Amounts" /><br />
	<asp:Label ID="lblAccountingNegativeMessage" runat="server" CssClass="SubHead" Text="If you dont know the base load amount at this time OR are unable to correct situation, please hit 'abort' to return to 'View Loads'" />
	<asp:HyperLink ID="hypAccountingNegative" runat="server" ImageUrl="~/images/cancel_changes.png" NavigateUrl="~/Default.aspx?tabname=View Loads"/>
	</td></tr>
</table>
	...
	<tr>
		<td width="180">
			<div class="jrctitletext fleft">&nbsp; Load Miles Calculator &nbsp;</div>
			<div class="col33per"><asp:Label ID="lblCalcMI" resourcekey="plCalcMI" CssClass="SubHead" runat="server"></asp:Label></div>
			<div class="col33per"><asp:Label ID="lblCalcRate" resourcekey="plCalcRate" CssClass="SubHead" runat="server"></asp:Label></div>
			<div class="col33per"><asp:Label ID="lblCalcTot" resourcekey="plCalcTot" CssClass="SubHead" runat="server"></asp:Label></div>

			<div class="col33per"><asp:TextBox ID="txtCalcMI" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="3" /><act:FilteredTextBoxExtender ID="fteCalcMI" runat="server" TargetControlID="txtCalcMI" FilterType="Numbers" /></div>
			<div class="col33per"><asp:TextBox ID="txtCalcRate" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="3" AutoPostBack="True" /><act:FilteredTextBoxExtender ID="fteCalcRate" runat="server" TargetControlID="txtCalcRate" FilterType="Numbers, Custom" ValidChars="+-." /></div>
			<div class="col33per"><asp:TextBox ID="txtCalcTot" CssClass="NormalTextBox NumericTextBox ReadOnlyTextBox" runat="server" Columns="4" AutoPostBack="True" ReadOnly="True" /></div>
		</td>
	</tr>
</table>
...
<table class="boxdisplay">
	<tr>
		<td width="180">
			<div class="jrctitletext fleft">
				<div class="col60per">&nbsp; Sales Rep &nbsp;</div>
				<div class="col40per"><asp:CheckBox ID="chkRepFixed" CssClass="fixed" Checked="true" Text="Fixed$" runat="server" AutoPostBack="True" /></div>
			</div>
			
					<div class="col40per normalbold">Override?<br />
					...
					<div class="fleft"><asp:Label ID="errOverrideCode" runat="server" CssClass="NormalRed" EnableViewState="false" /></div>
					<div class="col50per"><asp:Label ID="lblRepNo" runat="server" CssClass="NormalBold" /></div>
					<div class="col50per"><asp:Label ID="lblRepName" runat="server" CssClass="NormalBold" /></div>
					<div class="fleft"><asp:DropDownList ID="ddlRepNo" runat="server" CssClass="NormalTextBox" AutoPostBack="true" /></div>

					<div class="col50per"><asp:Label ID="plRepPct" runat="server" CssClass="NormalBold" Text="Comm %" /></div>
					<div class="col50per"><asp:Label ID="plRepDlr" runat="server" CssClass="NormalBold" Text="Comm $" /></div>

					<div class="col50per"><act:FilteredTextBoxExtender ID="fteRepPct" runat="server" FilterType="Numbers, Custom" TargetControlID="txtRepPct" ValidChars="+-." />
						<asp:TextBox ID="txtRepPct" runat="server" Columns="2" CssClass="NormalTextBox NumericTextBox" Text="0" /></div>
					<div class="col50per"><asp:TextBox ID="txtRepDlr" runat="server" Columns="7" CssClass="NormalTextBox NumericTextBox" Text="0" />
						<act:FilteredTextBoxExtender ID="fteRepDlr" runat="server" FilterType="Numbers, Custom" TargetControlID="txtRepDlr" ValidChars="+-." /></div>
                    ...
                    <td>
                        <table style="width: 180px" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                ...
                                <asp:Label ID="lblLoadID" runat="server" resourcekey="plLoadID" /><br />
                                    <asp:HyperLink ID="hypLoadID" runat="server" CssClass="SubHead" />                                    
                                    <p/>
                                    <asp:Label ID="lblIsPrinted" runat="server" Text="Printed?" /><br />
                                ...
                                <td align="center" class="SubHead" valign="top">
                                    ...
                                    <asp:LinkButton ID="lnbUpdateContinueEdit1" runat="server" BorderStyle="none" CssClass="CommandButton" resourcekey="update_and_edit" Text="Save &amp; Continue" Visible="False" />                                </td>
                            </tr>
                            <tr>
                              <td colspan="3" nowrap="nowrap" class="SubHead">
							              <table class="boxdisplay" width="180">
                							<tr>
                    							<td colspan="2" class="jrctitletext">Load Details</td>
                							</tr>
                							<tr>
...
<table width="50" border="0" align="right" cellspacing="0" class="alloc_tab">
            <tr id="trAccountingSummary" runat="server">
			  ...
			  <div id="acctcolumn">
                        ...
                        <div class="acctitem">
                            <div cssclass="alloc_amt"><asp:Label ID="txtGPPct" CssClass="alloc_amt" runat="server">0.00</asp:Label>%</div>
                        </div>
...
<table id="tblLoadAcctEdit" style="display: none" cellspacing="1" cellpadding="1" width="100%" border="0">
    ...
    <tr>
        ...
        <td class="Normal"><asp:CheckBox ID="chkJRC5050" resourcekey="chkJRC5050" CssClass="Normal" runat="server"></asp:CheckBox></td>
    </tr>
    <tr>
