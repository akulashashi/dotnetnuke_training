                ...
                <tr>
                    <td nowrap colspan="6">
                        <asp:RadioButtonList ID="rblSearchOn" CssClass="NormalTextBox" runat="server" RepeatDirection="Horizontal">
                            ...
                            <asp:ListItem Value="ANY" Text="Any" resourcekey="Any" Selected="True" /></asp:RadioButtonList></td>
                   <td nowrap colspan="3"><asp:Label ID="plJRCIOfficeCode" Text="Office" CssClass="SubHead" runat="server" /><asp:DropDownList ID="ddlJRCIOfficeCode" runat="server" AutoPostBack="True" /><asp:Image ID="imgHasProbDrivers" ImageUrl="~/images/ProbDrvs.gif" Visible="false" runat="server" /></td>
                </tr>
                <tr>
                    <td nowrap><asp:Label ID="plFromDate" Text="Date From" CssClass="SubHead" runat="server" /></td>
                  <td nowrap><asp:Label ID="plToDate" Text="Date To" CssClass="SubHead" runat="server" /></td>
                    <td nowrap class="subhead">Search</td>
                    <td nowrap class="subhead">Method</td>
                    <td nowrap><asp:CheckBox ID="chkDatewise" resourcekey="chkDatewise" CssClass="SubHead"  runat="server" /></td>
                    <td nowrap>&nbsp;</td>
                    <td valign="bottom" nowrap class="subhead"><div align="right">Legend</div></td>
                    <td valign="bottom" nowrap class="subhead"><span class="emaildrop">WIP <a id="dnn_ctr380_Views_ViewList_gdvViewList_ctl06_hypLoadStatus" title="WIP"><img title="WIP" src="/images/WIP.gif" /></a> SUSP <a id="dnn_ctr380_Views_ViewList_gdvViewList_ctl09_hypLoadStatus" title="SUSPENSE"><img title="SUSPENSE" src="/images/SUSPENSE.gif" /></a> COMP <a id="dnn_ctr380_Views_ViewList_gdvViewList_ctl03_hypLoadStatus" title="COMPLETE"><img title="COMPLETE" src="/images/COMPLETE.gif" /></a> VOID <a id="dnn_ctr380_Views_ViewList_gdvViewList_ctl04_hypLoadStatus" title="VOIDED"><img title="VOIDED" src="/images/VOIDED.gif" /></a></span></td>
                    <td valign="bottom" nowrap class="subhead">&nbsp;</td>
                </tr>
                <tr>
                    <td valign="top" nowrap><asp:TextBox ID="txtFrom" CssClass="NormalTextBox" runat="server" Columns="10" /><asp:HyperLink runat="server" ID="imgFrom" ImageUrl="~/images/calendar.png" Style="cursor: hand" />
                        <act:CalendarExtender ID="calFrom" TargetControlID="txtFrom" PopupButtonID="imgFrom" runat="server" Format="d" />
                  &nbsp;</td>
                    <td valign="top" nowrap><asp:TextBox ID="txtTo" CssClass="NormalTextBox" runat="server" Columns="10" /><asp:HyperLink runat="server" ID="imgTo" ImageUrl="~/images/calendar.png" Style="cursor: hand" />
                  <act:CalendarExtender ID="calTo" TargetControlID="txtTo" PopupButtonID="imgTo" runat="server" Format="d" />                   </td>
                    <td valign="top" nowrap><span class="subhead">
                      <asp:TextBox ID="txtSearch" CssClass="NormalTextBox" runat="server" />                      
                  </span></td>
                    <td valign="top" nowrap><asp:RadioButtonList ID="rblSearchType" CssClass="NormalTextBox" runat="server" RepeatDirection="Horizontal">
                    ...
                    <td valign="top" nowrap><span class="subhead">
                      <asp:Button ID="btnSearch" usesubmitbehavior="true" runat="server" resourcekey="Search" Width="125" Height="28" />                      
                  </span></td>
                    <td valign="top" nowrap>&nbsp;</td>
                    <td valign="middle" nowrap="nowrap" class="subhead"><asp:Label ID="LoadStatus" Text="Status: " CssClass="SubHead" runat="server" /></td>
                    <td valign="middle" nowrap="nowrap" class="emaildrop"><asp:DropDownList ID="ddlLoadStatus" runat="server" CssClass="NormalTextBox" AutoPostBack="True">
                    ...
                    <td valign="top" nowrap="nowrap" class="emaildrop">&nbsp;</td>
                </tr>
            </table>
      </td>
    </tr>
...
<asp:GridView ID="gdvViewList" DataSourceID="odsLoadSheets" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="None" Width="100%" EmptyDataText="<center class='NormalRed'>No Loads Found</center>">
    <Columns>
        <asp:TemplateField>
            ...
            <ItemTemplate>
                <table>
                    ...
                    <td style="width: 16px"><asp:HyperLink ID="hypPUDrops" runat="server" ImageUrl="~/images/PUDrops.gif"/></td>
        ...
        <asp:BoundField HeaderText="Base Load" DataField="BBaseLoad" SortExpression="BBaseLoad" DataFormatString="{0:0.00}" HtmlEncode="false" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:TemplateField>   
            <HeaderTemplate>
        ...
        <asp:BoundField HeaderText="Cust Bill" DataField="BCustBill" SortExpression="BCustBill" DataFormatString="{0:0.00}" HtmlEncode="false" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:TemplateField>   
            <HeaderTemplate>
                <span style="width:3px" />
            </HeaderTemplate>
...
<asp:ObjectDataSource ID="odsLoadSheets" runat="server" SelectMethod="GetSearchedLoadSheetsDT" DeleteMethod="DeleteLoadSheet" TypeName="bhattji.Modules.LoadSheets.Business.LoadSheetsController" DataObjectTypeName="bhattji.Modules.LoadSheets.Business.LoadSheetInfo" OldValuesParameterFormatString="original_{0}">
    <SelectParameters>
        ...
        <asp:Parameter Name="Datewise" Type="Boolean" DefaultValue="false" />
