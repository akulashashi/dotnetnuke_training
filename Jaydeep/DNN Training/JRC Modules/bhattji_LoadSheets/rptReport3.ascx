<%@ Control Language="vb" Inherits="bhattji.Modules.LoadSheets.rptReport3" Codebehind="rptReport3.ascx.vb" AutoEventWireup="False" Explicit="True" %>
    ...
    <tr>
        <td>
            ...
            <table>
                <tr>
                    <td class="SubHead">
                        <asp:Label ID="lblCustomer" Text="Customer" CssClass="SubHead" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="txtCustomerNumber" runat="server" CssClass="NormalTextBox" /><asp:ImageButton
                            ID="btnCustomerSearch" ImageUrl="~/images/view.gif" runat="server" CausesValidation="False" /></td>
                </tr>
                <tr>
                    <td class="SubHead">
                    ...
                    <tr>
                    <td><asp:RadioButtonList ID="rblSearchType" CssClass="NormalTextBox" runat="server" RepeatDirection="Horizontal">
            ...
            <table width="100%">
                <tr>
                    <td nowrap>
                        ...
                        <asp:TextBox ID="txtTo" CssClass="NormalTextBox" runat="server" Columns="10" /><asp:HyperLink ID="hypCalandarToDate" CssClass="CommandButton" ImageUrl="~/images/calendar.png" resourcekey="Calendar" runat="server" />
                   </td>
                    <td nowrap id="tdNoOfItems" runat="server" style="display:none">
                        <table style="display:none">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNoOfItems" Columns="3" CssClass="NormalTextBox" runat="server" />
                               </td>
                            </tr>
                        </table>
                   </td>
                    <td>
                        <asp:Label ID="plJRCIOfficeCode" Text="Office" CssClass="SubHead" runat="server" />
                        <asp:DropDownList ID="ddlJRCIOfficeCode" runat="server" AutoPostBack="True" />
                   </td>
                    <td nowrap align="right">
                        <asp:TextBox ID="txtSearch" CssClass="NormalTextBox" runat="server" /><asp:Button ID="btnSearch" UseSubmitBehavior="true" runat="server" resourcekey="Search" />
                   </td>
                    <td nowrap align="right">
                    ...
                    <td nowrap colspan="2" align="right" class="DisplayNone">
                        <asp:HyperLink ID="hypReport3" resourcekey="hypReport3" ImageUrl="~/images/print_this.png" NavigateUrl='<%# EditUrl("ReportType", "Report3", "Reports", "dnnprintmode=true&SkinSrc=%5BG%5D%2fskins%2f_default%2fno%20skin&ContainerSrc=%5BG%5D%2fcontainers%2f_default%2fno%20container") %>' Target="_blank" runat="server" />
                   </td>
                </tr>
            </table>
       </td>
...
<asp:GridView ID="gdvViewList" Caption="<h1>JRC Load Status Review</h1>" DataSourceID="odsLoadSheets" runat="server" AllowPaging="False" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="vertical" Width="100%" ShowFooter="True">
    <Columns>
       ...
       <asp:TemplateField HeaderText="LoadID" SortExpression="LoadID">
        ...
        <asp:BoundField HeaderText="Deliv Date" DataField="DeliveryDate" SortExpression="DeliveryDate" DataFormatString="{0:d}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
        ...
        <asp:BoundField HeaderText="Broker or Driver Name" DataField="CarrierName" SortExpression="CarrierName" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
        ...
        <asp:BoundField HeaderText="ProJob" DataField="ProJob" SortExpression="ProJob" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
        ...
        <asp:BoundField HeaderText="LastDrop" DataField="DPCityST" SortExpression="DPCityST" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
...
<asp:ObjectDataSource ID="odsLoadSheets" runat="server" SelectMethod="GetReport3" TypeName="bhattji.Modules.LoadSheets.Business.LoadSheetsController" DataObjectTypeName="bhattji.Modules.LoadSheets.Business.LoadSheetInfo">
    <SelectParameters>
