                        ...
                        <tr>
                            <td>
                                <table id="tblIORecovery1" runat="server" style="width: 255px">
                                    <tr>
                                        <td colspan="2">
                                            <asp:DropDownList ID="ddlIOOffN1" CssClass="NormalTextBox" runat="server" Style="display: none" Columns="24" AutoPostBack="true" />
                                            <asp:TextBox ID="txtIOOffN1" CssClass="NormalBold" ReadOnly="true" runat="server" Columns="24" /></td>
