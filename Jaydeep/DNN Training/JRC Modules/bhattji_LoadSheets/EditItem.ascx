    ...
    <table id="tblLoads" width="100%" border="0">
        ...
        <tr>
            <td align="left" valign="top" width="470">
                            ...
                            <table id="tblCustomer" runat="server" style="width: 100%">
                                <tr class="jrctitletext">
                                     <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                       <tr >
                                         <td width="37%">
                                         <asp:TextBox ID="txtCustomerName" Columns="60" CssClass="NormalTextBox" runat="server" AutoPostBack="true" /><asp:Panel ID="pnlCustomerNumber" Height="100px" ScrollBars="Vertical" runat="server"/>
                                         <act:AutoCompleteExtender ID="aceCustomerName" CompletionListElementID="pnlCustomerNumber" MinimumPrefixLength="1" ServicePath="~/DesktopModules/bhattji.LoadSheets/WebService.asmx" ServiceMethod="GetCustomerNames" runat="server" TargetControlID="txtCustomerName" CompletionListCssClass="CompletionListCssClass" CompletionListItemCssClass="CompletionListItemCssClass" CompletionListHighlightedItemCssClass="CompletionListHighlightedItemCssClass" CompletionSetCount="100" EnableCaching="true" /></td>
                                         <td width="2%" class="displaynone"><asp:ImageButton ID="btnCustomerSearch" runat="server" ImageUrl="~/images/view.gif" CausesValidation="false" /></td>
                                         <td width="61%" class="displaynone"><asp:TextBox ID="txtCustomerNumber" Columns="6" runat="server" CssClass="NormalTextBox" AutoPostBack="True" /></td>
                                       </tr>
                                     </table></td>
                                </tr>
                                <tr>
                                    <td colspan="2" nowrap="nowrap" class="SubHead">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
											   <td colspan="2" nowrap="nowrap" class="subhead">
                                        		<div class="col25per"><dnn:Label ID="plCustomerName" ControlName="txtCustomerName" Suffix=":" runat="server" class="subhead" /></div>
                                        		<div class="col75per"><nobr><asp:DropDownList ID="ddlCustomerNumber" columns="40" CssClass="NormalTextBox" runat="server" AutoPostBack="True" /><asp:Label ID="lblCustomerStatus" CssClass="NormalBold" runat="server" /></nobr></div></td>
                              	 </tr>
                                        </table>                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead nr" colspan="2"><asp:Label ID="lblCStatus" CssClass="NormalBold" runat="server" />
                                ...
                                <tr>
                                  <td width="50%" valign="top" class="SubHead"><asp:Label ID="lblCustomer" CssClass="NormalBold" runat="server" /></td>
                                    <td width="50%" valign="top" class="SubHead"><dnn:Label ID="plCustPO" ControlName="txtCustPO" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtCustPO" CssClass="NormalTextBox" Columns="25" MaxLength="50" Style="background-color: #FFFFA0; color: #000000" runat="server" /> <br />
                                    ...
                                    <td nowrap="nowrap" colspan="2">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <asp:DropDownList ID="ddlRepNo" runat="server" CssClass="NormalTextBox" />                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="jrctitletext fleft">
                                            <div class="col50per">
                                                <dnn:Label ID="plDriverName" runat="server" CssClass="jrctitletext" Suffix=":" ControlName="txtDriverName" />
                                            </div>
                                            <div class="col50per"><nobr><asp:DropDownList ID="ddlDriverCode" runat="server" CssClass="NormalTextBox" AutoPostBack="True" /><br /><asp:Label ID="lblDriverStatus" CssClass="NormalBold" runat="server" /></nobr></div>
                                        </div>
                                    </td>
                                </tr>
                                <tr style="display: none">
                            ...
                            <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                <tr>
                                    <td class="SubHead"><dnn:Label ID="plIOCode" runat="server" CssClass="SubHead" Suffix=":" ControlName="ddlIOCode" />
                                        <asp:DropDownList ID="ddlIOCode" runat="server" CssClass="NormalTextBox" AutoPostBack="true" />                                    </td>
                                    <td valign="top"><dnn:Label ID="plCanRecover" runat="server" ControlName="ddlCanRecover" Suffix=":" CssClass="SubHead" Text="Can Recover" />
                                        <asp:DropDownList ID="ddlCanRecover" DataValueField="DispatchCode" DataTextField="DispatchName" runat="server" CssClass="NormalTextBox" />                                    </td>
                ...
                <table width="100%" class="boxdisplay" id="tblBroker" style="width: 100%" runat="server">
                    <tr>
                        <td>
                            <table width="100%">
                                <tr CLASS="jrctitletext">
                                  <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                    <tr>
                                      <td width="45%">
                                        <asp:TextBox ID="txtBrokerName" runat="server" CssClass="NormalTextBox" Columns="60" AutoPostBack="true" /><asp:Panel ID="pnlBrokerCode" Height="100px" ScrollBars="Vertical" runat="server"/>
                                          <act:AutoCompleteExtender ID="aceBrokerName" CompletionListElementID="pnlBrokerCode" MinimumPrefixLength="1" ServicePath="~/DesktopModules/bhattji.LoadSheets/WebService.asmx" ServiceMethod="GetBrokerNames" runat="server" TargetControlID="txtBrokerName" CompletionListCssClass="CompletionListCssClass" CompletionListItemCssClass="CompletionListItemCssClass" CompletionListHighlightedItemCssClass="CompletionListHighlightedItemCssClass" CompletionSetCount="25" EnableCaching="true" /></td>
                                      <td width="3%"><asp:ImageButton ID="btnBrokerSearch" ImageUrl="~/images/view.gif" runat="server" CausesValidation="False" /></td>
                                      <td width="52%"><asp:TextBox ID="txtBrokerCode" runat="server" AutoPostBack="True" CssClass="NormalTextBox" Columns="6" /></td>
                                    </tr>
                                  </table></td>
                                </tr>
                                <tr>
                                            ...
                                            <tr>
                                                <td>
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                    <tr>
                                                      <td width="27%" class="subhead"><div align="right">
                                                        <dnn:Label ID="plBrokerName" runat="server" ControlName="txtBrokerName" />
                                                      </div></td>
                                                      <td width="73%"><nobr><asp:DropDownList ID="ddlBrokerCode" runat="server" CssClass="NormalTextBox" AutoPostBack="True" /><asp:Label ID="lblBrokerStatus" runat="server" CssClass="NormalBold" /></nobr></td>
                                                    </tr>
                                                  </table>
                                                </td>
                                            </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="57%" valign="top">
                                                    ...
                                                    <asp:Label ID="lblBroker" runat="server" CssClass="NormalBold" /> <asp:Label ID="lblUpdateBroker" runat="server" CssClass="NormalRed" /> <asp:Label ID="lblBrokerNotes" runat="server" CssClass="NormalRed" /> </td>
                                                <td width="43%" class="SubHead">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td valign="top" class="nr"><dnn:Label ID="plBkrDriverNo" ControlName="ddlBkrDriverNo" Suffix=":" CssClass="SubHead" runat="server" /></td>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="nr"><dnn:Label ID="plBkrInvNo" ControlName="txtBkrInvNo" Suffix=":" CssClass="SubHead" runat="server" /></td>
                                                            <td valign="top" class="nr"><asp:TextBox ID="txtBkrInvNo" CssClass="NormalTextBox" runat="server" Columns="10" /></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                    ...
                    <tr>
                        <td width="415">
                            <div class="jrctitletext">
                                Checks In / Out</div>
                            <div class="col50per">
                                <dnn:Label ID="plComCheckSeq" ControlName="txtComCheckSeq" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtComCheckSeq" CssClass="NormalTextBox" runat="server" /></div>
                            <div class="col50per">
                                <dnn:Label ID="plComCheckAmt" ControlName="txtComCheckAmt" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtComCheckAmt" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="7" />
          ...
          <td width="275" align="right" valign="top">
                <table class="boxdisplay" width="275">
                    <tr id="trLoadDelivery" runat="server">
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" id="tblLoadPUs" style="width: 300px" runat="server">
                                <tr style="display: none">
                ...
                <table class="boxdisplay" width="230">
                    <tr>
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" id="tblLoadDrops" style="width: 300px" runat="server">
                                <tr style="display: none">
                                    <td colspan="2" class="SubHead">
                                        LoadDrops
                                    </td>
                ...
                <table width="300" class="boxdisplay">
                  <tr>
                    <td width="300"><div class="jrctitletext"> &nbsp; Tarp/Trailer &nbsp;</div>
                        <table cellspacing="1" cellpadding="1" border="0" style="width: 300px">
                          <tr style="display: none">
                            <td class="SubHead" colspan="2"><dnn:Label ID="plTarpLoad" Text="Tarp" runat="server" CssClass="SubHead" Suffix=":" ControlName="chkTarpLoad" /></td>
                          </tr>
                          <tr>
                            <td width="63" nowrap="nowrap" class="SubHead"><dnn:Label ID="plTarpMessage" ControlName="txtTarpMessage" Suffix=":" CssClass="SubHead" runat="server" /></td>
                            <td width="230" align="left" class="Normal"><asp:CheckBox ID="chkTarpLoad" CssClass="Normal" runat="server" resourcekey="chkTarpLoad" AutoPostBack="true" />                            </td>
                          </tr>
                      ...
                      <div class="col50per">
                          <dnn:Label ID="plTrailerType" ControlName="ddlTrailerType" Suffix=":" CssClass="SubHead" runat="server" />
                      </div>
                      <div class="col50per">
                      ...
                      <div class="col50per">
                          <dnn:Label ID="plTrailerNumber" ControlName="txtTrailerNumber" Suffix=":" CssClass="SubHead" runat="server" />
                      </div>
                      <div class="col50per">
                          <asp:TextBox ID="txtTrailerNumber" CssClass="NormalTextBox" runat="server" Columns="18" MaxLength="20" />                  
                      </div>
                      <div class="col50per">
                          <dnn:Label ID="plTrailerDue" ControlName="txtTrailerDue" Suffix=":" CssClass="SubHead" runat="server" />
                      </div>
                      <div class="col50per">
                          <asp:TextBox ID="txtTrailerDue" Columns="10" CssClass="NormalTextBox" runat="server" /><asp:Image runat="server" ID="imgTrailerDue" ImageUrl="~/images/calendar.png" Style="cursor: hand" /><act:CalendarExtender ID="calTrailerDue" TargetControlID="txtTrailerDue" PopupButtonID="imgTrailerDue" runat="server" Format="d" />
                      </div>
                      

		<div class="col50per"><dnn:label id="plContainer1" controlname="txtContainer1" suffix=":" CssClass="SubHead" runat="server" /></div><div class="col50per"><asp:textbox id="txtContainer1"  CssClass="NormalTextBox" runat="server" Columns="18" MaxLength="20" /></div> 
		<div class="col50per"><dnn:label id="plContainer1Due" controlname="txtContainer1Due" suffix=":" CssClass="SubHead" runat="server"/></div><div class="col50per"><asp:textbox id="txtContainer1Due" CssClass="NormalTextBox" runat="server" Columns="10" /><asp:hyperlink id="hypContainer1Due" runat="server"  ImageUrl="~/images/calendar.png" style="cursor:hand"/><act:CalendarExtender ID="calContainer1Due" runat="server" TargetControlID="txtContainer1Due" PopupButtonID="hypContainer1Due" Format="d" /></div> 
		<div class="col50per"><dnn:label id="plContainer2" controlname="txtContainer2" suffix=":" CssClass="SubHead" runat="server" /></div><div class="col50per"><asp:textbox id="txtContainer2"  CssClass="NormalTextBox" runat="server" Columns="18" MaxLength="20" /></div> 
		<div class="col50per"><dnn:label id="plContainer2Due" controlname="txtContainer2Due" suffix=":" CssClass="SubHead" runat="server"/></div><div class="col50per"><asp:textbox id="txtContainer2Due" CssClass="NormalTextBox" runat="server" Columns="10" /><asp:hyperlink id="hypContainer2Due" runat="server"  ImageUrl="~/images/calendar.png" style="cursor:hand"/><act:CalendarExtender ID="calContainer2Due" runat="server" TargetControlID="txtContainer2Due" PopupButtonID="hypContainer2Due" Format="d" /></div> 
                      ...
                      <td align="center" valign="top" width="50%">
                          <table class="boxdisplay">
                              <tr>
                                  <td width="375">
                                      <div class="jrctitletext">
                                          &nbsp;Load Note 60 Characters each &nbsp;</div>
                                      <div class="DisplayNone">
                                          <div class="DisplayNone">
                                              <dnn:Label ID="plLoadNotes" runat="server" CssClass="SubHead" Suffix=":" ControlName="txtLoadNotes" />
                                          </div>
                                          <div class="alignc">
                                              <asp:TextBox ID="txtLoadNotes" runat="server" CssClass="NormalTextBox" Columns="70" MaxLength="60" /></div>
                                      </div>
                                      <div class="DisplayNone">
                                          <dnn:Label ID="plLDNotesA" runat="server" CssClass="SubHead" Suffix=":" ControlName="txtLDNotesA" />
                                      </div>
                                      <div class="alignc">
                                          <asp:TextBox ID="txtLDNotesA" runat="server" CssClass="NormalTextBox" Columns="70" MaxLength="60" /></div>
                                      <div class="DisplayNone">
                                          <dnn:Label ID="plLDNotesB" runat="server" CssClass="SubHead" Suffix=":" ControlName="txtLDNotesB" />
                                      </div>
                                    <div class="alignc">
                                      <asp:TextBox ID="txtLDNotesB" runat="server" CssClass="NormalTextBox" Columns="70" MaxLength="60" />                                    
                                    </div>
                                      <div class="DisplayNone">
                                          <dnn:Label ID="plLDNotesC" runat="server" CssClass="SubHead" Suffix=":" ControlName="txtLDNotesC" />
                                      </div>
                                      <div class="alignc">
                                          <asp:TextBox ID="txtLDNotesC" runat="server" CssClass="NormalTextBox" Columns="70" MaxLength="60" /></div>
                                      <div class="DisplayNone">
                                          <dnn:Label ID="plLDNotesD" runat="server" CssClass="SubHead" Suffix=":" ControlName="txtLDNotesD" />
                                      </div>
                                      <div class="alignc">
                                          <asp:TextBox ID="txtLDNotesD" runat="server" CssClass="NormalTextBox" Columns="70" MaxLength="60" /></div>                                  </td>
                              </tr>
                          </table>                        </td>
                        <td valign="top" width="50%">
                            <table class="boxdisplay">
                                <tr>
                                    <td width="375">
                                        <div class="jrctitletext">
                                            &nbsp; Inv Comment 50 Characters each &nbsp;</div>
                                        <div class="DisplayNone">
                                            <dnn:Label ID="plInvCommentA" ControlName="txtInvCommentA" Suffix=":" CssClass="SubHead" runat="server" />
                                        </div>
                                        <div class="alignc">
                                            <asp:TextBox ID="txtInvCommentA" CssClass="NormalTextBox" Style="background-color: #FFFFA0; color: #000000" runat="server" Columns="60" MaxLength="50" /></div>
                                        <div class="DisplayNone">
                                            <dnn:Label ID="plInvCommentB" ControlName="txtInvCommentB" Suffix=":" CssClass="SubHead" runat="server" />
                                        </div>
                                        <div class="alignc">
                                            <asp:TextBox ID="txtInvCommentB" CssClass="NormalTextBox" Style="background-color: #FFFFA0; color: #000000" runat="server" Columns="60" MaxLength="50" /></div>
                                        <div class="DisplayNone">
                                            <dnn:Label ID="plInvCommentC" ControlName="txtInvCommentC" Suffix=":" CssClass="SubHead" runat="server" />
                                        </div>
                                        <div class="alignc">
                                            <asp:TextBox ID="txtInvCommentC" CssClass="NormalTextBox" Style="background-color: #FFFFA0; color: #000000" runat="server" Columns="60" MaxLength="50" /></div>
                                        <div class="DisplayNone">
                                            <dnn:Label ID="plInvCommentD" ControlName="txtInvCommentD" Suffix=":" CssClass="SubHead" runat="server" />
                                        </div>
                                        <div class="alignc">
                                            <asp:TextBox ID="txtInvCommentD" CssClass="NormalTextBox" Style="background-color: #FFFFA0; color: #000000" runat="server" Columns="60" MaxLength="50" /></div>                                    </td>
                                </tr>
                            </table>                        </td>
                    </tr>
                </table>
...
<table id="tblLoadPUEdit" style="display: none" cellspacing="1" cellpadding="1">
    ...
    <tr>
        <td class="SubHead" colspan="2"><dnn:Label ID="plPUState" ControlName="txtPUState" Suffix=":" CssClass="SubHead" runat="server" /></td>
    </tr>
</table>
<table id="tblLoadDropEdit" style="display: none" cellspacing="1" cellpadding="1">
    ...
    <tr>
        <td class="SubHead" colspan="2"><dnn:Label ID="plDPState" ControlName="txtDPState" Suffix=":" CssClass="SubHead" runat="server" /></td>
    </tr>
    <tr>
