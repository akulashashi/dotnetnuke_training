<%@ Control Language="vb" Inherits="bhattji.Modules.LoadSheets.rptReport1" CodeBehind="rptReport1.ascx.vb" AutoEventWireup="False" Explicit="True" %>
...
<%--<h1 align="center">JRC Sales Summary</h1>--%>
<asp:GridView ID="gdvViewList" Caption="<h1>JRC Sales Summary</h1>" DataSourceID="odsLoadSheets" runat="server" AllowPaging="False" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemId" GridLines="vertical" Width="100%" ShowFooter="True">
    <Columns>
        <asp:BoundField HeaderText="Status" DataField="LoadStatus" SortExpression="LoadStatus" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
        ...
        <asp:BoundField HeaderText="LoadDate" DataField="LoadDate" SortExpression="LoadDate" DataFormatString="{0:d}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:BoundField HeaderText="Billing" DataField="BBaseLoad" SortExpression="BBaseLoad" DataFormatString="{0:n}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:BoundField HeaderText="Rep" DataField="RepDlr" SortExpression="RepDlr" HeaderStyle-CssClass="SubHead" DataFormatString="{0:n}" HtmlEncode="False" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:BoundField HeaderText="Carrier" DataField="DrTotDue" SortExpression="DrTotDue" DataFormatString="{0:n}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:BoundField HeaderText="I/O Office" DataField="JRCIOOffC1" SortExpression="JRCIOOffC1" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
        <asp:BoundField HeaderText="IO $ Comm" DataField="IOCommTot" SortExpression="IOCommTot" DataFormatString="{0:n}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:BoundField HeaderText="Mgr Office" DataField="IOOffL1" SortExpression="IOOffL1" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
        <asp:BoundField HeaderText="Mgr $ Comm" DataField="IOComm3" SortExpression="IOComm3" DataFormatString="{0:n}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:BoundField HeaderText="Office $ Comm" DataField="JRCOffComm" SortExpression="JRCOffComm" DataFormatString="{0:n}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:BoundField HeaderText="JRC Total" DataField="JRCTotal" SortExpression="JRCTotal" DataFormatString="{0:n}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <%--<asp:BoundField HeaderText="Fuel" DataField="BFuel" SortExpression="BFuel" DataFormatString="{0:n}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />--%>
        <asp:BoundField HeaderText="Fuel" DataField="OCommPlus" SortExpression="OCommPlus" DataFormatString="{0:n}" HtmlEncode="False" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
        <asp:BoundField HeaderText="Cust#" DataField="CustomerNumber" SortExpression="CustomerNumber" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
        ...
        <asp:BoundField HeaderText="Office#" DataField="JRCIOfficeCode" SortExpression="JRCIOfficeCode" HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="Normal" />
    </Columns>
    <EmptyDataTemplate>
...
<asp:ObjectDataSource ID="odsLoadSheets" runat="server" SelectMethod="GetReport1" TypeName="bhattji.Modules.LoadSheets.Business.LoadSheetsController" DataObjectTypeName="bhattji.Modules.LoadSheets.Business.LoadSheetInfo">
    <SelectParameters>
        ...
        <asp:Parameter Name="SortOn" Type="String" DefaultValue="LoadDate desc, JRCIOfficeCode, LoadId" />
