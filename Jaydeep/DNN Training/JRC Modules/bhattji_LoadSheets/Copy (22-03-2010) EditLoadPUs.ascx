<%@ Control Language="vb" Inherits="bhattji.Modules.LoadSheets.EditLoadPUs" CodeBehind="Copy (22-03-2010) EditLoadPUs.ascx.vb" AutoEventWireup="False" Explicit="True" %>
...
<table id="tblAddLoadPU" border="0" cellspacing="1" cellpadding="1" class="boxdisplay" Width="375" runat="server">
    <tr>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    <ProgressTemplate>
        <center>
            <asp:Image ID="Image1" ImageUrl="~/images/dnnanim.gif" runat="server" /></center>
    </ProgressTemplate>
</asp:UpdateProgress>
