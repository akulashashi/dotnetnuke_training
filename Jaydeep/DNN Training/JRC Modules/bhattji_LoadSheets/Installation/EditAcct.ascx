...
<asp:UpdateProgress ID="uprEditAccts" runat="server">
    ...
    <table width="100%" class="UpdateProgressClass"><tr><td></td></tr></table>
        <center style="position:absolute;width:100%;height:1000px;vertical-align:middle;z-index:2000;"><asp:Image ID="imgUpdateProgress" ImageUrl="~/images/dnnanim.gif" runat="server" Width="200" /><br /><asp:Image ID="Image5" ImageUrl="~/images/progressbar.gif" runat="server" Width="200" /></center>
    </progresstemplate>
</asp:UpdateProgress>
<asp:Panel ID="pnlBhattji" runat="server" Style="position: relative;">
    <center>
                        ...
                        <tr>
                            <td>
                                <table id="tblIORecovery1" runat="server" style="width: 255px">
                                    <tr>
                                        <td colspan="2">
                                            <asp:DropDownList ID="ddlIOOffN1" CssClass="NormalTextBox" runat="server" Columns="24" AutoPostBack="true" />
                                            <asp:TextBox ID="txtIOOffN1" CssClass="NormalBold" Style="display: none" runat="server" Columns="24" /></td>
                                    ...
                                    <tr>
                                        <td><asp:TextBox ID="txtIOComm1" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="6" /><act:filteredtextboxextender id="fteIOComm1" runat="server" filtertype="Numbers, Custom" targetcontrolid="txtIOComm1" validchars="+-." /></td>
                                        <td><asp:TextBox ID="txtIOAdmin1" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="4" /><act:filteredtextboxextender id="fteIOAdmin1" runat="server" filtertype="Numbers, Custom" targetcontrolid="txtIOAdmin1" validchars="+-." /></td>
                                ...
                                <table id="tblIORecovery2" runat="server" style="width: 255px">
                                    ...
                                    <tr>
                                        <td><asp:TextBox ID="txtIOOffC4" CssClass="NormalTextBox" runat="server" Columns="7" MaxLength="9" /><act:filteredtextboxextender id="fteIOOffC4" runat="server" filtertype="Numbers" targetcontrolid="txtIOOffC4" /></td>
                                        <td><asp:TextBox ID="txtIOOffN4" CssClass="NormalTextBox" runat="server" Columns="16" /></td>
                                        ...
                                        <td>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td><asp:Label ID="lblNet" CssClass="NormalBold" runat="server" Text="Net$" /></td>
                                                </tr>
                                                <tr>
                                                    <td><asp:TextBox ID="txtIOPct" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="4" /><act:filteredtextboxextender id="fteIOPct" runat="server" filtertype="Numbers, Custom" targetcontrolid="txtIOPct" validchars="+-." /></td>
                                                    ...
                                                    <td><asp:TextBox ID="txtNetIODlr" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="8" /><act:filteredtextboxextender id="fteNetIODlr" runat="server" filtertype="Numbers, Custom" targetcontrolid="txtNetIODlr" validchars="+-." /></td>
                                                </tr>
                                            </table>
                                       </td>
                                    </tr>
                            ...
                            <td>
                                <table style="width: 255px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="DisplayNone">
                                            <asp:CheckBox ID="chkSubOffComm" CssClass="Normal" runat="server" resourcekey="chkSubOffComm"></asp:CheckBox>
                                       </td>
                                    </tr>
                                </table>
                                <table id="tblCommissionsSplit3" runat="server" style="width: 255px">
                                    ...
                                    <tr>
                                        <td colspan="4" style="margin-left: 40px"><asp:TextBox ID="txtIOOffC3" CssClass="NormalTextBox" runat="server" Columns="6"></asp:TextBox> <asp:TextBox ID="txtIOOffN3" CssClass="NormalTextBox NumericTextBox" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td><asp:Label ID="lblCommAdmin" runat="server" CssClass="NormalBold">%% Comm</asp:Label></td>
                                        <td><asp:TextBox ID="txtIOAdmin3" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="4"></asp:TextBox></td>
                                        <td><asp:Label ID="lblCommAmt" runat="server" CssClass="NormalBold">Comm $ Amt</asp:Label></td>
                                        <td><asp:TextBox ID="txtIOComm3" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="4"></asp:TextBox></td>
                                    </tr>
                                </table>
                                ...
                                <table style="width: 160px">
                                    ...
                                    <asp:Label ID="lblLoadType" Text="LoadAccounting" CssClass="jrctitletext" runat="server" /><tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblLoadID" resourcekey="plLoadID" CssClass="SubHead" runat="server"></asp:Label><br />
                                            <asp:HyperLink ID="hypLoadID" CssClass="SubHead" runat="server" /></td>
                ...
                <td colspan="3">
                    <table width="100%" class="boxdisplay">
                        ...
                        <tr>
                            ...
                            <td align="right"><asp:TextBox ID="txtJRCTotal" CssClass="SubHead" runat="server" Text="0.00" Columns="4" ReadOnly="true" Style="text-align: right; border: none" /><act:filteredtextboxextender id="fteJRCTotal" runat="server" filtertype="Numbers, Custom" targetcontrolid="txtJRCTotal" validchars="+-." />
                           </td>
                            <td align="right"><asp:TextBox ID="txtGPPct" CssClass="SubHead" runat="server" Text="0.000" Columns="4" ReadOnly="true" Style="text-align: right; border: none" /><act:filteredtextboxextender id="fteGPPct" runat="server" filtertype="Numbers, Custom" targetcontrolid="txtGPPct" validchars="+-." />
                           </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="13" align="right"><asp:Label ID="errJRCTotal" CssClass="NormalRed" runat="server" />
        ...
        <table>
            ...
            <tr>
                <%--<td align="center"></td>--%>
                <td align="center" colspan="7" class="jrctitletd"><span class="jrctitletext">&nbsp; Update Icons &nbsp; </span></td>
                <td align="right" colspan="2" class="jrctitletd"><span class="jrctitletext">&nbsp; Cancel Icons &nbsp; </span></td>
            </tr>
            <tr>
                ...
                <td class="NormalBold" align="center" valign="top" width="9%"><asp:ImageButton ID="imbCopyLoad" ImageUrl="~/images/icon_lists_32px.gif" resourcekey="copy_load" CssClass="CommandButton" BorderStyle="none" OnClientClick="return confirm('Do you really wish to Copy this Load ?')" runat="server" />
                    <br />
                    <asp:LinkButton ID="lnbCopyLoad" Text="Copy" CssClass="CommandButton" BorderStyle="none" OnClientClick="return confirm('Do you really wish to Copy this Load ?')" runat="server" />
               </td>
                <td align="center" class="NormalBold" valign="top" width="9%"><asp:ImageButton ID="imbVoidLoad" runat="server" BorderStyle="none" CausesValidation="false" CssClass="CommandButton" ImageUrl="~/images/void_load.png" resourcekey="void_load" />
                    <br />
                    <asp:LinkButton ID="lnbVoidLoad" runat="server" BorderStyle="none" CausesValidation="false" CssClass="CommandButton" Text="Void" />
               </td>
