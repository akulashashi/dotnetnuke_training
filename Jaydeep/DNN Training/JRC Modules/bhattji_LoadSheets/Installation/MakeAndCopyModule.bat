...
@REM * Change to the Path where C:\DNN\JRC45\DesktopModules\bhattji_LoadSheets\Installation is Installed *
CD\DNN\JRC45\DesktopModules\bhattji_LoadSheets\Installation
...
@Echo *                                                *
@Echo * Press any key to Copy to Install Folder                        *
@Echo *                                                *
@Echo *                                                *
@Echo **************************************************

Pause
Copy bhattji_0*.zip C:\DNN\JRC45\Install\Module\
