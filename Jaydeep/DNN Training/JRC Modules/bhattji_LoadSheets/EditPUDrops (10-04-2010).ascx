        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="loadeditnav1">
            ...
            <tr>
              <td colspan="3">
                  <table width="780">
                      ...
                      <tr>
                          <td width="384" align="center" valign="top">
                              <div align="center" class="bighead">
                                  Pickups
                              </div>
                          </td>
                          <td width="384" align="center" valign="top">
                ...
                --%>
                      <tr>
                          <td colspan="2" align="center" class="displaynone"><asp:HyperLink ID="hypBack" NavigateUrl="javascript:history.go(-1);" ImageUrl="~/images/arrowleft32.png" resourcekey="cmdBack" CssClass="CommandButton" BorderStyle="none" runat="server" /> <asp:HyperLink ID="hypBack1" NavigateUrl="javascript:history.go(-1);" Text="Back" resourcekey="cmdBack" CssClass="CommandButton" BorderStyle="none" runat="server" /> </td>
                      </tr>
                  </table>
              </td>
            </tr>
