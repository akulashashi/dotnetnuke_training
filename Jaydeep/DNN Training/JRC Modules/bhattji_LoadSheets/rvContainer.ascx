...
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %><asp:Label ID="lblMsg" runat="server" CssClass="NormalRed" EnableViewState="false" />
                        ...
                        <table>
                            <tr>
                                <td colspan="2" nowrap>
                                    ...
                                    <nobr><asp:Label ID="plSearchDriver" runat="server" CssClass="SubHead" Text="Search Driver" Visible="false" /><asp:TextBox ID="txtSearchDriver" CssClass="ReptSearchBox" runat="server" Visible="false" />
                                                            <asp:DropDownList ID="ddlDriverStatus" runat="server" CssClass="NormalTextBox" AutoPostBack="True" Visible="false">
                            <asp:ListItem Value="N" Text="Active" />
                            <asp:ListItem Value="Y" Text="Inactive" />
                            <asp:ListItem Value="HOLD" Text="SafetyAuth" />
                            <asp:ListItem Value="" Text="<All>" />
                        </asp:DropDownList></nobr>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap align="right" class="style1"><asp:TextBox ID="txtSearch" CssClass="ReptSearchBox" runat="server" /></td>
        ...
        <td>
            <table width="100%">
                <tr>
                    ...
                    <td nowrap>
                               <span class="subhead">email it </span><br /> <asp:TextBox ID="txtEmail" runat="server" width= "200px" CssClass="NormalTextBox" />
                    </td>
                    <td align="right">
                    <div style="font-size:9px;font-weight:lighter;color:Navy;">email</div><asp:ImageButton ID="imbEmailPdf" ImageUrl="~/images/email_this.png" resourcekey="email_this" OnClientClick="return confirm('Are you sure, you wish to send eMail ?');" CssClass="CommandButton" BorderStyle="none" runat="server" /><br />
            <asp:LinkButton ID="lnbEmailPdf" Text="eMail PDF" 
                                        OnClientClick="return confirm('Are you sure, you wish to send eMail ?');" 
                                        CssClass="CommandButton" BorderStyle="none" runat="server" Visible="false" 
                                        Width="67px" />
                     </td>
                    <td nowrap align="right"><asp:ImageButton ID="imbPrintReport" ImageUrl="~/images/1x1.gif" resourcekey="imbPrintReport" ToolTip="Print this Report" CssClass="CommandButton" BorderStyle="none" runat="server" />
                        <div style="font-size:9px;font-weight:lighter;color:Navy;">print</div><asp:ImageButton ID="imbPrintSelection" ImageUrl="~/images/print_this.png" resourcekey="imbPrintReport" ToolTip="Print this Report" CssClass="CommandButton" BorderStyle="none" runat="server" />
                    </td>
                    <td nowrap>
                    <div style="font-size:9px;font-weight:lighter;color:Navy;">leave</div><asp:HyperLink ID="hypLoadList" runat="server" ImageUrl="~/images/update_and_list.png" NavigateUrl="~/Default.aspx?tabname=View Loads" ToolTip="To View Load List" />
                    </td>
