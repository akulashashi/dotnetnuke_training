            ...
            <td width="100%" background="/images/superior_17.gif">
                ...
                <td align="center" colspan="2"></td>
                    ...
                    <tr>
                        ...
                        <td width="32" align="center" valign="middle"><asp:LinkButton ID="lnbUpdateLoadsheet" Text="Load Edit" CssClass="topikons" BorderStyle="none" runat="server" /></td>                        
                        ...
                        <td width="10" align="center" valign="top"><img src="/images/superior_21.gif" width="2" height="30" /></td>
                        <td width="32" align="center" valign="middle" class="topikons"><asp:LinkButton ID="lnbUpdateAddNew" Text="Add Load" CssClass="topikons" BorderStyle="none" runat="server" /></td>
                        <td width="32"><asp:ImageButton ID="imbUpdateAddNew" ImageUrl="~/images/update_and_add.png" resourcekey="update_and_add" BorderStyle="none" runat="server" AlternateText="Save, then add new" /></td>
                        <td width="7" align="center" valign="top"><img src="/images/superior_21.gif" width="2" height="30" /></td>
                        <td width="32" align="center" valign="middle"><asp:LinkButton ID="lnbUpdateToList" Text="View Loads" CssClass="topikons" BorderStyle="none" runat="server" /></td>
                        <td width="32"><asp:ImageButton ID="imbUpdateToList" ImageUrl="~/images/update_and_list.png" resourcekey="update_and_list" BorderStyle="none" runat="server" AlternateText="Save, then bring back to list" /></td>
                        <td width="7" align="center" valign="top"><img src="/images/superior_21.gif" width="2" height="30" /></td>
                        <td width="32" align="center" valign="middle"><asp:LinkButton ID="lnbPrint" resourcekey="print_this" CssClass="topikons" BorderStyle="none" runat="server" /></td>
                        <td width="32"><asp:ImageButton ID="imbPrint" ImageUrl="~/images/print_this.png" resourcekey="print_this" BorderStyle="none" runat="server" AlternateText="Print Confirm" /></td>
                        <td width="1" align="center" valign="top"><img src="/images/superior_21.gif" width="2" height="30" /></td>
                        <td width="32" align="center" valign="middle"><asp:LinkButton ID="lnbPrintConfirm" resourcekey="print_Confirm" CssClass="topikons" BorderStyle="none" runat="server" /></td>
                        ...
                        <td width="100">&nbsp;</td>
                        <td class="DisplayNone" align="center" valign="middle" width="32"><asp:LinkButton ID="lnbEmail" Text="eMail" CssClass="topikons" BorderStyle="none" runat="server" OnClientClick="javascript:return confirm('By sending this email, you agree that this load is final and complete. Are you Sure ?')" /></td>
                        <td class="DisplayNone" width="32"><asp:ImageButton ID="imbEmail" ImageUrl="~/images/email_this.png" resourcekey="email_this" BorderStyle="none" runat="server" OnClientClick="javascript:return confirm('By sending this email, you agree that this load is final and complete. Are you Sure ?')" AlternateText="Email this load" /></td>
                        ...
                        <td class="DisplayNone" align="center" valign="middle" width="100">&nbsp;</td>
                        <td width="32" class="DisplayNone"><asp:ImageButton ID="imbCopyLoad" ImageUrl="~/images/icon_lists_32px.gif" ToolTip="Copy, Convert or Template this Load" BorderStyle="none" OnClientClick="return confirm('Do you really wish to Copy this Load ?')" runat="server" AlternateText="Make a copy of this load" /></td>
                        <td width="26" align="center" valign="top"><img src="/images/superior_21.gif" width="2" height="30" /></td>
                        <td width="32" align="center" valign="middle"><asp:LinkButton ID="lnbVoidLoad" OnClientClick="return confirm('Do you really wish to VOID this Load ?')" runat="server" CssClass="topikons" BorderStyle="none" CausesValidation="false" Text="Void" /></td>
                        <td width="32"><asp:ImageButton ID="imbVoidLoad" OnClientClick="return confirm('Do you really wish to VOID this Load ?')" runat="server" BorderStyle="none" CausesValidation="false" ImageUrl="~/images/void_load.png" resourcekey="void_load" AlternateText="Void this load" /></td>
                        <td width="10" align="center" valign="top"><img src="/images/superior_21.gif" width="2" height="30" /></td>
                        <td width="32" align="center" valign="middle"><asp:LinkButton ID="lnbCancelReload" runat="server" CssClass="topikons" BorderStyle="none" CausesValidation="false" Text="Undo" /></td>
                        <td width="32"><asp:ImageButton ID="imbCancelReload" runat="server" BorderStyle="none" CausesValidation="false" ImageUrl="~/images/cancel_changes.png" resourcekey="cancel_changes" AlternateText="Undo changes" /></td>
                        
                        
                        <td width="32" align="center" valign="middle"><asp:Label ID="lblIsPrinted" runat="server" CssClass="topikons" Text="Printed?" /></td>
                        <td width="32"><asp:Image ID="imgIsPrinted" CssClass="Normal" runat="server" resourcekey="imgIsPrinted" /></td>
                    </tr>
...
<asp:Panel ID="pnlBhattji" runat="server" Style="position: relative;">
    <center>
            ...
            <tr id="trAccountingSummary" runat="server">
                <td>
                    <table width="50" border="1" cellpadding="1" cellspacing="0">
                        <tr>
                            <td bgcolor="#CCB6CC"><asp:Label ID="txtLoadStatus" CssClass="SubHead" Style="font-weight: bold; border-width: 0;" runat="server" /></td>
                        </tr>
                        <tr>
                            <td bgcolor="#CCB6B6"><asp:Label ID="Label01" CssClass="NormalBold" runat="server" Text="Customer">Customer</asp:Label> <br />
                                <asp:Label ID="txtCustBill" CssClass="alloc_amt" runat="server" Text="0.00" /></td>
                        </tr>
                        <tr>
                            <td bgcolor="#D0CDCA"><asp:Label ID="lblIOComm" CssClass="alloc_lab" runat="server" Text="IO $">IO $</asp:Label> <br />
                                <asp:Label ID="txtIOCommTot" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#99954D"><asp:Label ID="lblIOAdmin" CssClass="alloc_lab" runat="server" Text="IO Adm$">IO Adm$</asp:Label> <asp:Label ID="txtIOAdminTot" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#BACC7F"><asp:Label ID="lblExclusion" CssClass="alloc_lab" runat="server" Text="Exclusion">Exclusion</asp:Label> <br />
                                <asp:Label ID="txtExTot" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#CC9090"><asp:Label ID="lblRepDue" CssClass="alloc_lab" runat="server" Text="Rep Due">Rep Due</asp:Label> <br />
                                <asp:Label ID="txtRep" CssClass="alloc_amt" runat="server" Text="0.00" /></td>
                        </tr>
                        <tr>
                            <td bgcolor="#CC9E78"><asp:Label ID="lblCarrierDue" CssClass="alloc_lab" runat="server" Text="Carrier$">Carrier$</asp:Label> <br />
                                <asp:Label ID="txtDRTotDue" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#CCCB73"><asp:Label ID="lblAPcomm4" CssClass="alloc_lab" runat="server" Text="Unbound">Unbound</asp:Label> <asp:Label ID="txtAPComm4" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FF9F9C"><asp:Label ID="lblAPcomm3" CssClass="alloc_lab" runat="server" Text="Unbound">Unbound</asp:Label> <br />
                                <asp:Label ID="txtAPComm3" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFBF8A"><span class="DisplayNone"><asp:Label ID="lblAPcomm2" CssClass="alloc_lab" runat="server" Text="Unbound">Unbound</asp:Label> <br />
                                <asp:Label ID="txtAPComm2" CssClass="alloc_amt" runat="server">0.00</asp:Label> </span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#33FF66"><asp:Label ID="lblJRCOffComm" CssClass="alloc_lab" runat="server" Text="Unbound">Unbound</asp:Label> <br />
                                <asp:Label ID="txtJRCOffComm" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFF9F"><asp:Label ID="lblJRCOnePct" CssClass="alloc_lab" runat="server" Text="% Admin">% Admin</asp:Label> <br />
                                <asp:Label ID="txtJRCOnePct" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#AACCAE"><asp:Label ID="lblJRCTotal" CssClass="alloc_lab" runat="server" Text="JRC Total">JRC</asp:Label> <br />
                                <asp:Label ID="txtJRCTotal" CssClass="alloc_amt" runat="server">0.00</asp:Label></td>
                        </tr>
                        <tr>
                            <td bgcolor="#D2FFFF" cssclass="alloc_amt"><asp:Label ID="txtGPPct" CssClass="alloc_amt" runat="server">0.00</asp:Label>%</td>
                        </tr>
                        
                        
                        <tr>
                            <td bgcolor="#D2FFD2" cssclass="alloc_amt"><asp:CheckBox ID="chkAdjustJrcTotal" CssClass="alloc_amt" runat="server" Text="Adjust Total" /></td>
                        </tr>
                        
                    </table>
                    <asp:ImageButton ID="imbJrcTotal" runat="server" ImageUrl="~/images/accounting_small.png" Visible="False" />
                    <asp:Label ID="errJRCTotal" CssClass="NormalRed" runat="server" />
                    <%--<asp:CompareValidator ID="valGPPct" runat="server" ControlToValidate="txtGPPct" Display="None" ErrorMessage="JRC Percentage should be greater than 4.80%" Operator="GreaterThanEqual" SetFocusOnError="True" Type="Double" ValueToCompare="4.80" /><act:validatorcalloutextender id="vlxGPPct" runat="Server" targetcontrolid="valGPPct" warningiconimageurl="~/images/red-error.gif"/>--%></td>
            </tr>
        </table>
        <table>
            <tr>
                    ...
                    <table class="boxdisplay">
                        ...
                        <tr>
                            <td style="width: 320px">
                                <table>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBBaseLoad" resourcekey="plBBaseLoad" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBBaseLoad" CssClass="custbilldol" runat="server" Columns="8" /><act:FilteredTextBoxExtender ID="fteBBaseLoad" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBBaseLoad" ValidChars="+-." />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblDiscountPCT" resourcekey="plDiscountPCT" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtDiscountPCT" CssClass="custbilldol" runat="server" Columns="1" /><act:FilteredTextBoxExtender ID="fteDiscountPCT" runat="server" FilterType="Numbers, Custom" TargetControlID="txtDiscountPCT" ValidChars="+-.">
                                    ...
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBDeten" resourcekey="plBDeten" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBDeten" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBDeten" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBDeten" ValidChars="+-." />
                                            <asp:CheckBox ID="chkBINC3" resourcekey="chkBINC3" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBTolls" resourcekey="plBTolls" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBTolls" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBTolls" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBTolls" ValidChars="+-." />
                                            <asp:CheckBox ID="chkBINC4" resourcekey="chkBINC4" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBFuel" resourcekey="plBFuel" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBFuel" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBFuel" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBFuel" ValidChars="+-.">
                                        </act:FilteredTextBoxExtender>
                                            <asp:CheckBox ID="chkBINC5" resourcekey="chkBINC5" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBDrop" resourcekey="plBDrop" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBDrop" CssClass="custbilldol" runat="server" Columns="7" /><act:FilteredTextBoxExtender ID="fteBDrop" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBDrop" ValidChars="+-.">
                                        </act:FilteredTextBoxExtender>
                                            <asp:CheckBox ID="chkBINC6" resourcekey="chkBINC6" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBRecon" resourcekey="plBRecon" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBRecon" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBRecon" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBRecon" ValidChars="+-.">
                                        </act:FilteredTextBoxExtender>
                                            <asp:CheckBox ID="chkBINC7" resourcekey="chkBINC7" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBTarp" resourcekey="plBTarp" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBTarp" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBTarp" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBTarp" ValidChars="+-.">
                                        </act:FilteredTextBoxExtender>
                                            <asp:CheckBox ID="chkBINC8" resourcekey="chkBINC8" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBLumper" resourcekey="plBLumper" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBLumper" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBLumper" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBLumper" ValidChars="+-.">
                                        </act:FilteredTextBoxExtender>
                                            <asp:CheckBox ID="chkBINC9" resourcekey="chkBINC9" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBUnload" resourcekey="plBUnload" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td nowrap><asp:TextBox ID="txtBUnload" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBUnload" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBUnload" ValidChars="+-.">
                                        </act:FilteredTextBoxExtender>
                                            <asp:CheckBox ID="chkBINC10" resourcekey="chkBINC10" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBAdminMisc" resourcekey="plBAdminMisc" CssClass="custbilldol" runat="server"></asp:Label></td>
                                        <td class="SubHead" nowrap><asp:TextBox ID="txtBAdminMisc" CssClass="custbilldol" runat="server" Columns="7"></asp:TextBox><act:FilteredTextBoxExtender ID="fteBAdminMisc" runat="server" FilterType="Numbers, Custom" TargetControlID="txtBAdminMisc" ValidChars="+-.">
                                        </act:FilteredTextBoxExtender>
                                            <asp:CheckBox ID="chkBINC11" resourcekey="chkBINC11" CssClass="Normal" runat="server" Checked="True"></asp:CheckBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="SubHead" nowrap><asp:Label ID="lblBCustBill" resourcekey="plBCustBill" CssClass="custbilldol" runat="server"></asp:Label></td>
        ...
        </td> </tr> </table> </td> <td valign="top" align="center" style="width: 330px">
                        ...
                        <table style="width: 255px">
                            <caption style="text-align: left" class="jrctitletext">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="59%" class="jrctitletext">&nbsp; Broker &nbsp;</td>
                                        <td width="41%">
                                            <asp:CheckBox ID="chkBKFixed" resourcekey="chkBKFixed" CssClass="fixed" Text="Fixed $" runat="server" AutoPostBack="True" Checked="True" /></td>
                                    </tr>
                                </table>
                            </caption>
                            <tr>
                                ...
                                <td>
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td class="DisplayNone" nowrap><asp:Label ID="lblIOFixed" CssClass="SubHead" runat="server" Text="Fixed$" /></td>
                                        ...
                                        <tr>
                                            <td><asp:TextBox ID="txtIOPct" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="4" /><act:FilteredTextBoxExtender ID="fteIOPct" runat="server" FilterType="Numbers, Custom" TargetControlID="txtIOPct" ValidChars="+-." />
                                            </td>
                                            <td class="DisplayNone">
                                                <asp:CheckBox ID="chkIOFixed" resourcekey="chkIOFixed" CssClass="Normal" runat="server" AutoPostBack="True" /></td>
                                            <td><asp:TextBox ID="txtIODlr" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="8" /><act:FilteredTextBoxExtender ID="fteIODlr" runat="server" FilterType="Numbers, Custom" TargetControlID="txtIODlr" ValidChars="+-." />
                                            </td>
                                            <td class="DisplayNone"><asp:TextBox ID="txtNetIODlr" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="8" /><act:FilteredTextBoxExtender ID="fteNetIODlr" runat="server" FilterType="Numbers, Custom" TargetControlID="txtNetIODlr" ValidChars="+-." />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                    ...
                    <td>
                        <table style="width: 255px">
                            <caption style="text-align: left" class="jrctitletext">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="59%" class="jrctitletext">&nbsp; Driver &nbsp;</td>
                                        <td width="41%">
                                            <asp:CheckBox ID="chkOOFixed" runat="server" AutoPostBack="True" CssClass="fixed" resourcekey="chkOOFixed" Checked="False" /></td>
                                    </tr>
                                </table>
                            </caption>
                            <tr>
                ...
                <tr>
                    <td>
                        <table id="tblComCheck" runat="server" style="width: 100%">
                            ...
                            <tr>
                                <td width="10" class="fixed_blue">Com#</td>
                                <td width="110" class="SubHead"><asp:TextBox ID="txtComCheckSeq" CssClass="NormalTextBox" runat="server" /></td>
                                <td width="10" class="fixed_blue">$</td>
                                <td width="110" class="SubHead"><asp:TextBox ID="txtComCheckAmt" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="7" /><act:FilteredTextBoxExtender ID="fteComCheckAmt" runat="server" FilterType="Numbers, Custom" TargetControlID="txtComCheckAmt" ValidChars="+-." />
                                </td>
                            </tr>
                        </table>
                        <table id="tblCodCheck" runat="server" style="width: 100%">
                            <tr>
                                <td width="10" class="fixed_blue">COD#</td>
                                <td width="110" class="SubHead"><asp:TextBox ID="txtCodCheckSeq" CssClass="NormalTextBox" runat="server" /></td>
                                <td width="10" class="fixed_blue">$</td>
                                <td width="110" class="SubHead"><asp:TextBox ID="txtCodCheckAmt" CssClass="NormalTextBox NumericTextBox" runat="server" Columns="7" /><act:FilteredTextBoxExtender ID="fteCodCheckAmt" runat="server" FilterType="Numbers, Custom" TargetControlID="txtCodCheckAmt" ValidChars="+-." />
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <td align="right" valign="top">
                    ...
                    <td>
                        <table style="width: 160px">
                            ...
                            <tr>
                                ...
                                <td><asp:TextBox ID="txtCalcTot" CssClass="NormalTextBox NumericTextBox ReadOnlyTextBox" runat="server" Columns="4" AutoPostBack="True" ReadOnly="True" /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td>
                        <table style="width: 160px">
                            <caption style="text-align: left" class="jrctitletext">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="59%" class="jrctitletext">&nbsp; Sales Rep &nbsp;</td>
                                        <td width="41%">
                                            <asp:CheckBox ID="chkRepFixed" CssClass="fixed" Checked="true" Text="Fixed$" runat="server" AutoPostBack="True" /></td>
                                    </tr>
                                </table>
                            </caption>
                            <tr>
                                <td><asp:Label ID="plOverrideCode" resourcekey="plOverrideCode" runat="server" CssClass="NormalBold" /></td>
                                <td>
                                    <asp:CheckBox ID="chkOverrideCode" runat="server" AutoPostBack="true" /><asp:TextBox ID="txtOverrideCode" runat="server" CssClass="NormalTextBox" Columns="8" AutoPostBack="true" Visible="false" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td nowrap><asp:Label ID="plRepPct" runat="server" CssClass="NormalBold" Text="Comm %" /></td>
                                <td nowrap><asp:Label ID="plRepDlr" runat="server" CssClass="NormalBold" Text="Comm $" /></td>
                            </tr>
                            <tr>
                                <td nowrap>
                                    <act:FilteredTextBoxExtender ID="fteRepPct" runat="server" FilterType="Numbers, Custom" TargetControlID="txtRepPct" ValidChars="+-." />
                                    <asp:TextBox ID="txtRepPct" runat="server" Columns="2" CssClass="NormalTextBox NumericTextBox" Text="0" /><%--<asp:Label ID="lblRepPct" CssClass="NormalBold" runat="server" />--%> </td>
                                <td nowrap><asp:TextBox ID="txtRepDlr" runat="server" Columns="7" CssClass="NormalTextBox NumericTextBox" Text="0" />
                                    <act:FilteredTextBoxExtender ID="fteRepDlr" runat="server" FilterType="Numbers, Custom" TargetControlID="txtRepDlr" ValidChars="+-." />
                                    <%--<asp:Label ID="lblRepDlr" CssClass="NormalBold" runat="server" />--%> </td>
                            </tr>
                        </table>
            ...
            <table class="boxdisplay">
                <tr>
                    <td>
                        <table style="width: 160px" cellpadding="0" cellspacing="0" border="0">
