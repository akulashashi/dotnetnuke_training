        ...
        <tr>
            <td width="50%" valign="top" nowrap="nowrap" align="left">
                <table id="jrccustomertable" runat="server" class="boxdisplay" width="100%" style="margin-top: 3px;">
                    <tr>
                      <td style="text-align: left" class="jrctitletext"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          ...
                          <td valign="top" class="displaynone"><asp:radiobuttonlist id="rblCustomerSearchType" CssClass="NormalTextBox" Runat="server" RepeatDirection="Horizontal">
                                  ...
                                  <td class="Normal" valign="top">
                                        <table id="tblBroker" runat="server">
                                            <tr>
                                              ...
                                              <td><asp:DropDownList ID="ddlBrokerCode" runat="server" CssClass="NormalTextBox" AutoPostBack="True">
                                            ...
                                            <tr>
                                              ...
                                              <td class="Normal"><asp:Label ID="lblBroker" runat="server" CssClass="NormalBold" /></td>
                                            </tr>
                                            <tr>
                                              <td class="displaynone"><asp:RadioButtonList ID="rblBrokerSearchType" RepeatDirection="Horizontal" CssClass="NormalTextBox" runat="server">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top"><span class="SubHead">
                                                    <asp:DropDownList ID="ddlBkrDriverNo" runat="server" CssClass="NormalTextBox">
                                                        <asp:ListItem Value="ZXZX" Text="N/A" />                                                    </asp:DropDownList>
                                                </span></td>
                                            </tr>
                                            <tr>
