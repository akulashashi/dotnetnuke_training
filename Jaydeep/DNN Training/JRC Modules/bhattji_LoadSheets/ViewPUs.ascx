<%@ Control Language="vb" Inherits="bhattji.Modules.LoadSheets.ViewPUs" CodeBehind="ViewPUs.ascx.vb" AutoEventWireup="False" Explicit="True" %>
        ...
        <Columns>
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <table>
                        <tr valign="top">
                            <td style="width: 16px"><asp:ImageButton runat="server" CssClass="DisplayNone" ImageUrl="~/images/edit.gif" resourcekey="Edit" CommandName="Edit" CausesValidation="false" ID="cmdEdit" />
                                <asp:ImageButton ID="imbEditPU" runat="server" ImageUrl="~/images/edit.gif" resourcekey="Edit" CommandName="EditPU" CausesValidation="false" />
                           </td>
                            <td style="width: 16px"><asp:ImageButton ID="imbDelete" CssClass="DisplayNone" runat="server" ImageUrl="~/images/delete.gif" resourcekey="cmdDelete" CommandName="Delete" CausesValidation="false" />
                                <asp:ImageButton ID="imbDeletePU" runat="server" ImageUrl="~/images/delete.gif" resourcekey="cmdDelete" CommandName="DeletePU" CausesValidation="false" />
                           </td>
                            <td style="width: 16px"><asp:ImageButton runat="server" ImageUrl="~/images/up.gif" resourcekey="Up" CommandName="Up" CausesValidation="false" ID="cmdUp" />
                           </td>
                            <td style="width: 16px"><asp:ImageButton runat="server" ImageUrl="~/images/dn.gif" resourcekey="Down" CommandName="Down" CausesValidation="false" ID="cmdDown" />
                           </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="<nobr>City / State</nobr>" HeaderStyle-CssClass="jrctitletext" ItemStyle-VerticalAlign="Top">
                <ItemTemplate>
                    <asp:Label ID="lblSeq" runat="server" CssClass="DisplayNone" Text='<%# Eval("Seq") %>' /> <asp:Label ID="lblPUCity" CssClass="Normal" Style="background-color: #FFFFA0; color: #000000" runat="server" Text='<%# Eval("PUCity") %>' />/<asp:Label ID="lblPUState" CssClass="Normal" Style="background-color: #FFFFA0; color: #000000" runat="server" Text='<%# Eval("PUState") %>' />
                </ItemTemplate>
            </asp:TemplateField>
...
<table id="tblAddLoadPU" border="0" cellspacing="1" cellpadding="1" runat="server">
    <tr>
        <td class="SubHead" colspan="2">
            <table>
                <tr>
                    <td nowrap><dnn:Label ID="plPUCity" ControlName="txtPUCity" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtPUCity" Columns="22" CssClass="NormalTextBox" runat="server" AutoPostBack="true" />
                    <act:AutoCompleteExtender ID="acePUCity"  MinimumPrefixLength="1" ServicePath="~/DesktopModules/bhattji.LoadSheets/WebService.asmx" ServiceMethod="GetCityNames" runat="server" TargetControlID="txtPUCity" CompletionListCssClass="CompletionListCssClass" CompletionListItemCssClass="CompletionListItemCssClass" CompletionListHighlightedItemCssClass="CompletionListHighlightedItemCssClass" CompletionSetCount="25" EnableCaching="true" />
                    </td>
                    ...
                    <td nowrap><dnn:Label ID="plPUDate" ControlName="txtPUDate" Suffix=":" CssClass="SubHead" runat="server" /><asp:TextBox ID="txtPUDate" Columns="8" CssClass="NormalTextBox" runat="server" /><act:CalendarExtender ID="actPUDate" TargetControlID="txtPUDate" PopupButtonID="imgPUDate" runat="server" Format="d" /><asp:Image runat="server" ID="imgPUDate" ImageUrl="~/images/calendar.png" Style="cursor: hand" /><%--<asp:RequiredFieldValidator ID="valPUDate" ControlToValidate="txtPUDate" runat="server" ErrorMessage="Pick-up date is Required" Display="None"/><act:ValidatorCalloutExtender runat="Server" ID="vlxPUDate" TargetControlID="valPUDate" WarningIconImageUrl="~/images/red-error.gif" />--%></td>
                </tr>
            </table>
       </td>
    </tr>    
    ...
    <tr id="trAdditionalInfo" runat="server">
        <td class="SubHead" valign="top"><dnn:Label ID="plPUName" ControlName="txtPUName" Suffix=":" CssClass="SubHead" runat="server" /> <asp:TextBox ID="txtPUName" CssClass="NormalTextBox" runat="server" /><br />
        ...
        <td class="SubHead" valign="top"><dnn:Label ID="plPRONo" ControlName="txtPRONo" Suffix=":" CssClass="SubHead" runat="server" /> <asp:TextBox ID="txtPRONo" CssClass="NormalTextBox" runat="server" />
            <table>
            <tr><td nowrap><dnn:Label ID="plPUTime" ControlName="txtPUTime" Suffix=":" CssClass="SubHead" runat="server" /></td><td nowrap align="right"><asp:TextBox ID="txtPUTime" CssClass="NormalTextBox NumericTextBox" Columns="6" runat="server" /></td></tr>
            <tr><td nowrap><dnn:Label ID="plPieces" ControlName="txtPieces" Suffix=":" CssClass="SubHead" runat="server" /></td><td nowrap align="right"><asp:TextBox ID="txtPieces" CssClass="NormalTextBox NumericTextBox" Columns="6" runat="server" /></td></tr>
            <tr><td nowrap><dnn:Label ID="plWeight" ControlName="txtWeight" Suffix=":" CssClass="SubHead" runat="server" /></td><td nowrap align="right"><asp:TextBox ID="txtWeight" CssClass="NormalTextBox NumericTextBox" Columns="6" runat="server" /></td></tr>
            <tr><td nowrap><dnn:Label ID="plMiles" ControlName="txtMiles" Suffix=":" CssClass="SubHead" runat="server" /></td><td nowrap align="right"><asp:TextBox ID="txtMiles" CssClass="NormalTextBox NumericTextBox" Columns="6" runat="server" /></td></tr>
            </table>
