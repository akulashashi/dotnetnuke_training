...
@REM * Change to the Path where C:\DNN\JRC45\DesktopModules\bhattji_Dispatchs\Installation is Installed *
CD\DNN\JRC45\DesktopModules\bhattji_Dispatchs\Installation
