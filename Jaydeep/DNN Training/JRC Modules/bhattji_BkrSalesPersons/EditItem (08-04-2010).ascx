                    ...
                    <tr>
                        <td>
                            <table width="630" border="0" cellspacing="3" cellpadding="0">
                                <tr>
                                    <td width="82" align="left" valign="top"><span class="SubHead"><dnn:Label ID="plDriverCode" runat="server" Suffix=":" ControlName="txtDriverCode" CssClass="SubHead"></dnn:Label></span></td>
                                    <td width="30" align="left" valign="top"><asp:TextBox ID="txtDriverCode" runat="server" CssClass="NormalTextBox" Columns="4" MaxLength="4" />
                                        ...
                                        <act:FilteredTextBoxExtender ID="actDriverCode" runat="server" TargetControlID="txtDriverCode" FilterType="Numbers,UppercaseLetters,LowercaseLetters" />
                                   </td>
                                    ...
                                    <td width="155" align="left" valign="top">
                                        <nobr><asp:TextBox ID="txtBrokerCodeD" runat="server" CssClass="NormalTextBox" Columns="25" AutoPostBack="true" /><asp:ImageButton ID="btnBrokerSearch" ImageUrl="~/images/view.gif" runat="server" CausesValidation="False" /></nobr>
                                    ...
                                    <td width="175" align="left" valign="top">
                                        <asp:DropDownList ID="ddlBrokerCodeD" runat="server" CssClass="NormalTextBox" AutoPostBack="true" DataTextField="BrokerName" DataValueField="BrokerCode" />
                            ...
                            <table style="width: 630px">
                                ...
                                <tr>
                                    <td><span class="SubHead"><asp:TextBox ID="txtDFirstName" runat="server" CssClass="NormalTextBox"></asp:TextBox> </span></td>
                                    <td><span class="SubHead"><asp:TextBox ID="txtDLastName" runat="server" CssClass="NormalTextBox"></asp:TextBox> </span></td>
                                    <td>
                    ...
                    <tr>
                        <td>
                            <table style="width: 350px">
                                <tr>
                                    <td><dnn:Label ID="plDriverName" runat="server" Suffix=":" ControlName="txtDriverName" CssClass="SubHead"></dnn:Label></td>
                                ...
                                <tr>
                                    <td class="SubHead"><dnn:Label ID="plPhoneNo" runat="server" Suffix=":" ControlName="txtPhoneNo" CssClass="SubHead"></dnn:Label></td>
                                    <td class="SubHead"><asp:TextBox ID="txtPhoneNo" runat="server" CssClass="NormalTextBox" Style="text-align: right" /> <asp:Label ID="plExt" runat="server" CssClass="SubHead" Text="Ext"></asp:Label> <asp:TextBox ID="txtExt" runat="server" CssClass="NormalTextBox" Columns="3"></asp:TextBox>
                                        <act:MaskedEditExtender runat="server" ID="meePhoneNo" TargetControlID="txtPhoneNo" Mask="(999)999-9999" MaskType="None" ClearMaskOnLostFocus="false" ClearTextOnInvalid="false" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" InputDirection="RightToLeft" AcceptNegative="None" />
                                   </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="Normal"><asp:TextBox ID="txtFaxNo" runat="server" CssClass="NormalTextBox" Style="text-align: right" />
                                        <act:MaskedEditExtender runat="server" ID="meeFaxNo" TargetControlID="txtFaxNo" Mask="(999)999-9999" MaskType="None" ClearMaskOnLostFocus="false" ClearTextOnInvalid="false" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" InputDirection="RightToLeft" AcceptNegative="None" />
                                   </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><span class="SubHead"><dnn:Label ID="plPager" runat="server" Suffix=":" ControlName="txtPager" CssClass="SubHead"></dnn:Label></span>
                                        <act:MaskedEditExtender runat="server" ID="meeCellPhone" TargetControlID="txtCellPhone" Mask="(999)999-9999" MaskType="None" ClearMaskOnLostFocus="false" ClearTextOnInvalid="false" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" InputDirection="RightToLeft" AcceptNegative="None" />
                                   </td>
                                    <td><asp:TextBox ID="txtPager" runat="server" CssClass="NormalTextBox" Style="text-align: right" />
                                        <act:MaskedEditExtender runat="server" ID="meePager" TargetControlID="txtPager" Mask="(999)999-9999" MaskType="None" ClearMaskOnLostFocus="false" ClearTextOnInvalid="false" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" InputDirection="RightToLeft" AcceptNegative="None" />
                                   </td>
                                </tr>
                                <tr>
                                    <td class="SubHead"><dnn:Label ID="plEmailAddress" runat="server" Suffix=":" ControlName="txtEmailAddress" CssClass="SubHead"></dnn:Label></td>
                ...
                <table class="boxdisplay">
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td class="SubHead"><dnn:Label ID="plLastLoadID" runat="server" Suffix=":" ControlName="txtLastLoadID" CssClass="SubHead"></dnn:Label></td>
                                    <td class="SubHead"><dnn:Label ID="plLastLoad" runat="server" Suffix=":" ControlName="txtLastLoad" CssClass="SubHead"></dnn:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><dnn:Label ID="plLastLoadDeliv" runat="server" Suffix=":" ControlName="txtLastLoadDeliv" CssClass="SubHead"></dnn:Label></td>
                                ...
                                <tr>
                                    <td class="SubHead"><dnn:Label ID="plLastPU" runat="server" Suffix=":" ControlName="txtLastPU" CssClass="SubHead"></dnn:Label></td>
                                    <td class="SubHead"><dnn:Label ID="plLastDP" runat="server" Suffix=":" ControlName="txtLastDP" CssClass="SubHead"></dnn:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><dnn:Label ID="plLastTrailerUsed" runat="server" Suffix=":" ControlName="txtLastTrailerUsed" CssClass="SubHead"></dnn:Label></td>
                                    <td><asp:TextBox ID="txtLastTrailerUsed" runat="server" CssClass="NormalBold" ReadOnly="true" BorderWidth="0"></asp:TextBox></td>
                                </tr>
                            </table>
                       </td>
                    </tr>
                        ...
                        <td colspan="2">
                            <table id="Table7" cellspacing="1" cellpadding="1" border="0">
                                <tr>
                                    <td class="SubHead"></td>
                                    <td></td>
                                    <td class="DisplayNone"><dnn:Label ID="plAdminExempt" runat="server" Suffix=":" ControlName="chkAdminExempt" CssClass="SubHead"></dnn:Label></td>
                                    <td class="DisplayNone">
                                        <asp:CheckBox ID="chkAdminExempt" runat="server" CssClass="Normal" resourcekey="chkAdminExempt"></asp:CheckBox></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" colspan="2"><dnn:Label ID="plDrugDate" runat="server" Suffix=":" ControlName="txtDrugDate" CssClass="SubHead"></dnn:Label></td>
                                    <td class="SubHead" colspan="2"><dnn:Label ID="plTruckInsDate" runat="server" Suffix=":" ControlName="txtTruckInsDate" CssClass="SubHead"></dnn:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="SubHead" colspan="2"><dnn:Label ID="plLicenceDate" runat="server" Suffix=":" ControlName="txtLicenceDate" CssClass="SubHead"></dnn:Label></td>
                                    <td class="SubHead" colspan="2"><dnn:Label ID="plTrailerInsDate" runat="server" Suffix=":" ControlName="txtTrailerInsDate" CssClass="SubHead"></dnn:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="SubHead" colspan="2"><dnn:Label ID="plRegRenewDate" runat="server" Suffix=":" ControlName="txtRegRenewDate" CssClass="SubHead"></dnn:Label></td>
                                    <td class="SubHead" colspan="2"><dnn:Label ID="plNewLeaseDate" runat="server" Suffix=":" ControlName="txtNewLeaseDate" CssClass="SubHead"></dnn:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="SubHead" colspan="2"><dnn:Label ID="plMedicalDate" runat="server" Suffix=":" ControlName="txtMedicalDate" CssClass="SubHead"></dnn:Label></td>
                                    <td class="SubHead" colspan="2"><dnn:Label ID="plLogBookOS" runat="server" Suffix=":" ControlName="chkLogBookOS" CssClass="SubHead"></dnn:Label></td>
                                </tr>
                                <tr>
...
<table id="Table2" style="display: none" cellspacing="0" cellpadding="0" summary="Edit SalesPersons Design Table" border="0">
    ...
    <tr>
        <td class="SubHead"><dnn:Label ID="plSafetyAuth" runat="server" Suffix=":" ControlName="txtSafetyAuth" CssClass="SubHead"></dnn:Label></td>
    ...
    <tr>
        <td class="SubHead"><dnn:Label ID="plSafetyNotes" runat="server" Suffix=":" ControlName="txtSafetyNotes" CssClass="SubHead"></dnn:Label></td>
