...
<center>
    ...
    <table id="Table1" cellspacing="1" cellpadding="1" border="0">
                        ...
                        <td>
                            <table style="width: 630px">
                                <tr>
                                    ...
                                    <td class="SubHead">
                                        <dnn:Label ID="plDriverName" runat="server" Suffix=":" ControlName="txtDriverName" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td class="SubHead">
                                        <dnn:Label ID="plOfficeOwner" runat="server" Suffix=":" ControlName="ddlOfficeOwner" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td class="SubHead">
                                        <dnn:Label ID="plStatus" runat="server" Suffix=":" ControlName="chkStatus" CssClass="SubHead"></dnn:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><asp:TextBox ID="txtDriverCode" runat="server" CssClass="NormalTextBox" Columns="4" MaxLength="4"/><asp:RequiredFieldValidator ID="valDriverCode" ControlToValidate="txtDriverCode" runat="server" CssClass="NormalRed" Display="Dynamic" ErrorMessage="Driver Code Cannot be null" SetFocusOnError="true" />
                                ...
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plBrokerCodeD" runat="server" Suffix=":" ControlName="txtBrokerCodeD" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td><asp:TextBox ID="txtBrokerCodeD" runat="server" CssClass="NormalTextBox" Columns="9" AutoPostBack="true" /><asp:ImageButton ID="btnBrokerSearch" ImageUrl="~/images/view.gif" runat="server" CausesValidation="False" /><asp:RequiredFieldValidator ID="valBrokerCodeD" ControlToValidate="txtBrokerCodeD" runat="server" CssClass="NormalRed" Display="Dynamic" ErrorMessage="<br/>Broker Code Cannot be null" SetFocusOnError="true" /><asp:CustomValidator ID="cvBrokerCodeD" runat="server" ErrorMessage="<br />Broker Code must be 7 digit long" ClientValidationFunction="ClientValidate7char" ControlToValidate="txtBrokerCodeD" Display="Dynamic"/></td>
                                    <td colspan="2">
                    ...
                    <tr>
                        <td>
                            <table style="width: 250px">
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plDLastName" runat="server" Suffix=":" ControlName="txtDLastName" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td class="SubHead">
                                        <dnn:Label ID="plDFirstName" runat="server" Suffix=":" ControlName="txtDFirstName" CssClass="SubHead"></dnn:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead"><asp:TextBox ID="txtDLastName" runat="server" CssClass="NormalTextBox"></asp:TextBox></td>
                                    <td><asp:TextBox ID="txtDFirstName" runat="server" CssClass="NormalTextBox"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plAddressLine1" runat="server" Suffix=":" ControlName="txtAddressLine1" CssClass="SubHead"></dnn:Label>
                                    </td>
                                ...
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plCity" runat="server" Suffix=":" ControlName="txtCity" CssClass="SubHead"></dnn:Label>
                                    </td>
                                ...
                                <tr class="DisplayNone">
                                    <td class="SubHead">
                                        <dnn:Label ID="plCountryCode" runat="server" Suffix=":" ControlName="txtCountryCode" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td><asp:TextBox ID="txtCountryCode" runat="server" CssClass="NormalTextBox"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plPhoneNo" runat="server" Suffix=":" ControlName="txtPhoneNo" CssClass="SubHead"></dnn:Label>
                                    </td>
                                ...
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plFaxNo" runat="server" Suffix=":" ControlName="txtFaxNo" CssClass="SubHead"></dnn:Label>
                                    </td>
                                ...
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plCellPhone" runat="server" Suffix=":" ControlName="txtCellPhone" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td class="SubHead">
                                ...
                                <tr>
                                    <td><asp:TextBox ID="txtCellPhone" runat="server" CssClass="NormalTextBox" Style="text-align: right"/>
                                ...
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plEmailAddress" runat="server" Suffix=":" ControlName="txtEmailAddress" CssClass="SubHead"></dnn:Label>
                                    </td>
        ...
        <tr>
            <td valign="top" id="trAccountAdmin" runat="server">
                <table class="boxdisplay">
                    <tr>
                        ...
                        <td>
                            <table style="width: 250px">
                                <tr id="trAccountNo" runat="server" visible="false">
                                    <td class="SubHead">
                                        <dnn:Label ID="plAccountNo" runat="server" Suffix=":" ControlName="txtAccountNo" CssClass="SubHead"></dnn:Label>
                                    </td>
                                ...
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plCommRate" runat="server" Suffix=":" ControlName="txtCommRate" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td><asp:TextBox ID="txtCommRate" runat="server" CssClass="NormalTextBox"></asp:TextBox></td>
                                </tr>
                                <tr class="DisplayNone">
                                    <td class="SubHead">
                                        <dnn:Label ID="plCalc85" runat="server" Suffix=":" ControlName="chkCalc85" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plJRCTrailer" runat="server" Suffix=":" ControlName="txtJRCTrailer" CssClass="SubHead"></dnn:Label>
                                    </td>
                                    <td><asp:TextBox ID="txtJRCTrailer" runat="server" CssClass="NormalTextBox"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="SubHead">
                                        <dnn:Label ID="plDriverNotes" runat="server" Suffix=":" ControlName="txtDriverNotes" CssClass="SubHead"></dnn:Label>
                                    </td>
