...
Partial Class rvLoadConfirm
    ...
    Private Sub RunReport()
        ...
        Dim dt As DataTable = ctrl.GetLoadConfirmHeader(itemId)
        Dim loadId = ctrl.GetLoadId(itemId)
        Dim dt2 As DataTable = ctrl.GetReportLoadPUByLoadId(loadId)
        Dim dt3 As DataTable = ctrl.GetReportLoadDropByLoadId(loadId)
